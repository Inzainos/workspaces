...
**Generado:** 2026-08-09 00:09 UTC (18:09 UTC-6)
...
| Hora de la medición | 2026-08-09 00:07 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 19.4, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 19.4 | 8.1 | 8.6 | 19.4 | P100 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 4 | P89 |
| Silent Trigger | inactivo | 67% ciclos | 72% ciclos | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M4 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 376 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 11 | ~9 días |
...
| alfa2 | _en vivo · 349 ciclos · 62216 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 290
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,945
...
| Asertividad viva | 9.0% | 9.0% | -0.1% |
| Aciertos / Fallos (vivos) | 290 / 2,945 | 290 / 2,921 | +0 aciertos |
...
| **Total predicciones** | 871321 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178874/181819 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
- **Predicción hecha:** 2026-08-05 20:02 UTC
- **Resuelto:** 2026-08-08 20:03:30 UTC
...
- **Predicción hecha:** 2026-08-05 19:42 UTC
- **Resuelto:** 2026-08-08 20:03:30 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
_... y 868366 aciertos más en los últimos 30 días_
...
*Ciclos totales: 4,132 · Sentinel Omega · Fractal Core Research*
