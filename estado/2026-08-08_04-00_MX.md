...
**Generado:** 2026-08-08 10:00 UTC (04:00 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **8.8** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-08 09:57 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.8, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.8 | 7.8 | 8.5 | 16.8 | P67 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 4 | P88 |
| Silent Trigger | inactivo | 77% ciclos | 75% ciclos | — | — |
...
| **89%** `▓▓▓▓░` | SISMO_M4 | **Ghost Scotia Arc** (-57.0, -30.0) · nodo 97 | 207 | ~8 días |
...
| alfa2 | _en vivo · 334 ciclos · 59518 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,789
- PENDIENTE — ventana de 72h aún abierta: 886
...
| Asertividad viva | 9.1% | 9.2% | -0.1% |
| Aciertos / Fallos (vivos) | 279 / 2,789 | 279 / 2,765 | +0 aciertos |
| Pendientes de auditoría | 886 | 888 | -2 |
...
| **Total predicciones** | 871154 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178863/181652 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 3,962 · Sentinel Omega · Fractal Core Research*
