...
**Generado:** 2026-08-08 07:47 UTC (01:47 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **9.0** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-08 07:47 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.0, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.0 | 7.7 | 8.5 | 16.8 | P69 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 4 | P88 |
| Silent Trigger | inactivo | 78% ciclos | 76% ciclos | — | — |
...
| alfa2 | _en vivo · 332 ciclos · 59158 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 279
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,765
- PENDIENTE — ventana de 72h aún abierta: 884
...
| Aciertos / Fallos (vivos) | 279 / 2,765 | 278 / 2,741 | +1 aciertos |
| Pendientes de auditoría | 884 | 889 | -5 |
...
| **Total predicciones** | 871130 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178863/181628 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
_... y 868355 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,936 · Sentinel Omega · Fractal Core Research*
