...
**Generado:** 2026-08-07 04:05 UTC (22:05 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **6.5** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-07 04:03 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.5, muro 2/5 y firma máxima 100%.
...
| **95%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 98 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 255 | ~8 días |
...
| alfa2 | _en vivo · 305 ciclos · 54391 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 257
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,459
- PENDIENTE — ventana de 72h aún abierta: 879
...
| Aciertos / Fallos (vivos) | 257 / 2,459 | 256 / 2,450 | +1 aciertos |
| Pendientes de auditoría | 879 | 864 | +15 |
...
| **Total predicciones** | 870802 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178841/181300 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
_... y 868333 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,603 · Sentinel Omega · Fractal Core Research*
