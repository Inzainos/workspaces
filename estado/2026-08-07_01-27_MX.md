...
**Generado:** 2026-08-07 07:27 UTC (01:27 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **6.6** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-07 07:27 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.6, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.6 | 7.8 | 8.7 | 16.8 | P15 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 4 | P88 |
| Silent Trigger | activo | 81% ciclos | 75% ciclos | — | — |
...
| **88%** `▓▓▓▓░` | SISMO_M5 | **Ghost Scotia Arc** (-57.0, -30.0) · nodo 97 | 104 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 98 | ~8 días |
...
| alfa2 | _en vivo · 308 ciclos · 54925 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 262
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,503
- PENDIENTE — ventana de 72h aún abierta: 871
...
| Asertividad viva | 9.5% | 9.5% | +0.0% |
| Aciertos / Fallos (vivos) | 262 / 2,503 | 259 / 2,481 | +3 aciertos |
| Pendientes de auditoría | 871 | 880 | -9 |
...
| **Total predicciones** | 870851 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178846/181349 | 99% `▓▓▓▓▓▓▓▓` | 0.98 |
...
_... y 868338 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,644 · Sentinel Omega · Fractal Core Research*
