...
**Generado:** 2026-08-06 07:12 UTC (01:12 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **7.5** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-06 07:12 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.5, muro 2/5 y firma máxima 100%.
...
| **91%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 174 | ~8 días |
...
- PENDIENTE — ventana de 72h aún abierta: 640
...
| Asertividad viva | 9.4% | 9.3% | +0.1% |
| Aciertos / Fallos (vivos) | 255 / 2,450 | 251 / 2,441 | +4 aciertos |
| Pendientes de auditoría | 640 | 641 | -1 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 9% → 10% → 10% → 9% → 9%*
...
*Ciclos totales: 3,353 · Sentinel Omega · Fractal Core Research*
