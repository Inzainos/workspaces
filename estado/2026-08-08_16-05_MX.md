...
**Generado:** 2026-08-08 22:05 UTC (16:05 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **14.0** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-08 22:02 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 14.0, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 14.0 | 8.0 | 8.5 | 16.8 | P95 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 4 | P89 |
| Silent Trigger | inactivo | 68% ciclos | 73% ciclos | — | — |
...
| alfa2 | _en vivo · 347 ciclos · 61858 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,921
...
| Aciertos / Fallos (vivos) | 290 / 2,921 | 288 / 2,898 | +2 aciertos |
| Pendientes de auditoría | 888 | 889 | -1 |
...
| **Total predicciones** | 871297 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178874/181795 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 4,107 · Sentinel Omega · Fractal Core Research*
