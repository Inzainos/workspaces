...
**Generado:** 2026-08-07 01:26 UTC (19:26 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **6.3** `▓░░░░░░░░░` | actividad moderada |
| Consenso de los 6 bots | NEUTRAL (20%) | evaluando |
| Muro de los 5 frentes | 2/5 activos | estable — sin convergencia crítica |
| Precursores detectados | 5 | ["SILENT_TRIGGER", "SEISMIC_CLUSTER", "PRECIPITACION", "PRECIPITACION", "PRECIPITACION"] |
| Hora de la medición | 2026-08-07 01:25 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.3, muro 2/5 y firma máxima 100%.
...
|---|---|---|
| Precipitación Potencial (Schumann-Modular) | 65% `▓▓▓░░` | colima |
| Precipitación Potencial (Schumann-Modular) | 65% `▓▓▓░░` | guerrero |
| Precipitación Potencial (Schumann-Modular) | 65% `▓▓▓░░` | tlaxcala |
...
| **93%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 98 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M4 | **Ghost Scotia Arc** (-57.0, -30.0) · nodo 97 | 91 | ~8 días |
...
| alfa2 | _en vivo · 302 ciclos · 53679 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 9.5% |
| **Últimos 7 días** (viva) | 9.6% |
...
- ACIERTO — avisó y el evento ocurrió: 256
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,450
- PENDIENTE — ventana de 72h aún abierta: 857
...
| Asertividad viva | 9.5% | 9.4% | +0.0% |
| Aciertos / Fallos (vivos) | 256 / 2,450 | 255 / 2,450 | +1 aciertos |
| Pendientes de auditoría | 857 | 843 | +14 |
...
| **Total predicciones** | 870792 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178840/181290 | 99% `▓▓▓▓▓▓▓▓` | 0.99 |
...
- **Predicción hecha:** 2026-08-03 04:43 UTC
- **Resuelto:** 2026-08-06 06:14:05 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-03 04:33 UTC
- **Resuelto:** 2026-08-06 06:14:04 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-03 04:28 UTC
- **Resuelto:** 2026-08-06 06:14:04 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-02 23:43 UTC
- **Resuelto:** 2026-08-06 00:02:23 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-02 23:38 UTC
- **Resuelto:** 2026-08-06 00:02:23 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-02 23:33 UTC
- **Resuelto:** 2026-08-06 00:02:23 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-02 22:58 UTC
- **Resuelto:** 2026-08-06 00:02:22 UTC
- **Qué pasó:** 1 eventos en ventana de 72h (máx M4.8, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva

#### PADRE — watch

- **Predicción hecha:** 2026-08-02 22:53 UTC
- **Resuelto:** 2026-08-06 00:02:22 UTC
- **Qué pasó:** 1 eventos en ventana de 72h (máx M4.8, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva

_... y 868332 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,571 · Sentinel Omega · Fractal Core Research*
