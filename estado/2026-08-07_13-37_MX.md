...
**Generado:** 2026-08-07 19:37 UTC (13:37 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **5.9** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-07 19:37 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 5.9, muro 2/5 y firma máxima 100%.
...
| **94%** `▓▓▓▓▓` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 30 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 103 | ~8 días |
...
| alfa2 | _en vivo · 320 ciclos · 57061 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 266
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,641
- PENDIENTE — ventana de 72h aún abierta: 875
...
| Asertividad viva | 9.2% | 9.2% | -0.1% |
| Aciertos / Fallos (vivos) | 266 / 2,641 | 266 / 2,619 | +0 aciertos |
| Pendientes de auditoría | 875 | 877 | -2 |
...
| **Total predicciones** | 870993 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178850/181491 | 99% `▓▓▓▓▓▓▓▓` | 0.98 |
...
- **Predicción hecha:** 2026-08-04 13:32 UTC
- **Resuelto:** 2026-08-07 14:08:13 UTC
...
- **Predicción hecha:** 2026-08-04 13:27 UTC
- **Resuelto:** 2026-08-07 14:08:13 UTC
- **Qué pasó:** 3 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
_... y 868342 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,790 · Sentinel Omega · Fractal Core Research*
