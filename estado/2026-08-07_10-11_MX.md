...
**Generado:** 2026-08-07 16:11 UTC (10:11 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **6.0** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-07 16:07 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.0, muro 2/5 y firma máxima 100%.
...
| **88%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 103 | ~8 días |
...
| alfa2 | _en vivo · 317 ciclos · 56527 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,595
...
| Aciertos / Fallos (vivos) | 266 / 2,595 | 264 / 2,572 | +2 aciertos |
| Pendientes de auditoría | 879 | 880 | -1 |
...
| **Total predicciones** | 870947 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178850/181445 | 99% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 3,748 · Sentinel Omega · Fractal Core Research*
