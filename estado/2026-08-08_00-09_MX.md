...
**Generado:** 2026-08-08 06:09 UTC (00:09 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **6.4** `▓░░░░░░░░░` | actividad moderada |
| Consenso de los 6 bots | NO_SIGNAL (0%) | evaluando |
| Muro de los 5 frentes | 3/5 activos | 🚨 **BREACH** — varios dominios alterados a la vez |
| Precursores detectados | 3 | ["NIEBLA_TULE", "SEISMIC_CLUSTER", "SCHUMANN"] |
| Hora de la medición | 2026-08-08 06:07 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.4, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.4 | 7.7 | 8.5 | 16.8 | P15 |
| Muro de los 5 | 3 | 2.0 | 2.1 | 4 | P100 |
| Silent Trigger | inactivo | 79% ciclos | 76% ciclos | — | — |
...
| Niebla Tule (Anomalía) | 70% `▓▓▓▓░` | guerrero |
| Resonancia Schumann | 70% `▓▓▓▓░` | global |
| Enjambre Sísmico Local | 95% `▓▓▓▓▓` | regional |
| Niebla Tule (Anomalía) | 70% `▓▓▓▓░` | guerrero |
| Resonancia Schumann | 70% `▓▓▓▓░` | global |
...
| **93%** `▓▓▓▓▓` | SISMO_M4 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 376 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 65 | ~8 días |
...
| alfa2 | _en vivo · 331 ciclos · 58975 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 9.2% |
| **Últimos 7 días** (viva) | 9.5% |
...
- ACIERTO — avisó y el evento ocurrió: 278
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,741
- PENDIENTE — ventana de 72h aún abierta: 889
...
| Asertividad viva | 9.2% | 9.3% | -0.0% |
| Aciertos / Fallos (vivos) | 278 / 2,741 | 277 / 2,717 | +1 aciertos |
| Pendientes de auditoría | 889 | 889 | +0 |
...
| **Total predicciones** | 871105 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178862/181603 | 98% `▓▓▓▓▓▓▓▓` | 0.98 |
...
- **Predicción hecha:** 2026-08-05 02:12 UTC
- **Resuelto:** 2026-08-08 04:06:02 UTC
...
- **Predicción hecha:** 2026-08-05 01:27 UTC
- **Resuelto:** 2026-08-08 02:02:21 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 23:52 UTC
- **Resuelto:** 2026-08-08 00:14:03 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 21:06 UTC
- **Resuelto:** 2026-08-07 22:09:12 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 20:41 UTC
- **Resuelto:** 2026-08-07 22:09:11 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 20:32 UTC
- **Resuelto:** 2026-08-07 22:09:11 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 20:26 UTC
- **Resuelto:** 2026-08-07 22:09:11 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 20:21 UTC
- **Resuelto:** 2026-08-07 22:09:11 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 20:02 UTC
- **Resuelto:** 2026-08-07 20:05:10 UTC
- **Qué pasó:** 2 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva
...
- **Predicción hecha:** 2026-08-04 19:51 UTC
- **Resuelto:** 2026-08-07 20:05:10 UTC
- **Qué pasó:** 3 eventos en ventana de 72h (máx M4.9, nodos de la predicción)
- **Confianza:** 35.0% `▓▓▓▓░░░░░░`
- **Fase:** viva

_... y 868354 aciertos más en los últimos 30 días_
...
*Ciclos totales: 3,916 · Sentinel Omega · Fractal Core Research*
