...
**Generado:** 2026-08-10 18:05 UTC (12:05 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **11.7** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-10 18:01 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 11.7, muro 3/5 (breach) y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.7 | 8.4 | 8.7 | 20.9 | P89 |
| Muro de los 5 | 3 | 2.1 | 2.1 | 4 | P100 |
...
| **90%** `▓▓▓▓▓` | SISMO_M5 | **Kamchatka** (53.0, 159.0) · nodo 20 | 45 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Ghost Scotia Arc** (-57.0, -30.0) · nodo 97 | 104 | ~8 días |
...
| alfa2 | _en vivo · 354 ciclos · 63115 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 429
...
| Asertividad viva | 15.5% | 15.5% | +0.0% |
| Aciertos / Fallos (vivos) | 579 / 3,153 | 579 / 3,153 | +0 aciertos |
| Pendientes de auditoría | 429 | 408 | +21 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 9% → 9% → 9% → 9% → 15%*
...
*Ciclos totales: 4,178 · Sentinel Omega · Fractal Core Research*
