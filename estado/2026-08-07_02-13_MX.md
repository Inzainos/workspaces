...
**Generado:** 2026-08-07 08:13 UTC (02:13 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **6.7** `▓░░░░░░░░░` | actividad moderada |
| Consenso de los 6 bots | NO_SIGNAL (0%) | evaluando |
| Muro de los 5 frentes | 2/5 activos | estable — sin convergencia crítica |
| Precursores detectados | 2 | ["SEISMIC_CLUSTER", "SCHUMANN"] |
| Hora de la medición | 2026-08-07 08:12 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.7, muro 2/5 y firma máxima 100%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.7 | 7.8 | 8.7 | 16.8 | P18 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 4 | P88 |
| Silent Trigger | inactivo | 80% ciclos | 75% ciclos | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M5 | **Ghost Scotia Arc** (-57.0, -30.0) · nodo 97 | 104 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 260 | ~8 días |
...
| alfa2 | _en vivo · 309 ciclos · 55103 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| Aciertos / Fallos (vivos) | 262 / 2,503 | 262 / 2,503 | +0 aciertos |
| Pendientes de auditoría | 880 | 871 | +9 |
...
*Ciclos totales: 3,653 · Sentinel Omega · Fractal Core Research*
