...
**Generado:** 2026-07-24 10:26 UTC (04:26 UTC-6)
...
| Hora de la medición | 2026-07-24 10:26 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 12.3, muro 3/5 (breach) y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 12.3 | 8.5 | 10.8 | 25.4 | P79 |
| Muro de los 5 | 3 | 2.6 | 1.9 | 3 | P100 |
| Silent Trigger | activo | 60% ciclos | 48% ciclos | — | — |
| Asertividad viva | 43% | 36% | — | — | — |
...
| **86%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 155 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.98 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 1.10 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.85 `▓▓▓░░░` |
| delta | 380 | 15,727 | 0.85 `▓▓▓░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.67 `▓▓▓░░░` |
| alfa2 | _en vivo · 178 ciclos · 34125 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 43.4% |
| **Últimos 7 días** (viva) | 36.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.98 |
| beta1 | 99.9% | 66.3% | — | 1.10 |
| beta2 | 99.6% | 23.3% | — | 0.85 |
| delta | 99.9% | 27.3% | — | 0.85 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 48.4% | 36.1% | 0.67 |
...
- ACIERTO — avisó y el evento ocurrió: 2,190
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,852
- PENDIENTE — ventana de 72h aún abierta: 26
...
| Asertividad viva | 43.4% | — | — |
| Aciertos / Fallos (vivos) | 2,190 / 2,852 | — | — aciertos |
| Pendientes de auditoría | 26 | — | — |
| Pesos de bots | alfa1 0.98, beta1 1.10, beta2 0.85, delta 0.85, omega 1.00, padre 0.67 | — | primera bitácora |
...
*Ciclos totales: 132 · Sentinel Omega · Fractal Core Research*
