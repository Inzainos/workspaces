...
**Generado:** 2026-07-03 03:11 UTC (21:11 UTC-6)
...
| Hora de la medición | 2026-07-03 03:09 UTC | |
...
|---|---|---|---|---|
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 295 | ~7 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 22 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mid-Atlantic S** (10.0, -40.0) · nodo 80 | 146 | ~7 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 24 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M7 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 5 | ~11 días |
...
| Velocidad promedio del viento solar | 1994.95 | 1312.22 | más presente cuando el evento llega PRONTO |
...
- PENDIENTES (avisos cuya ventana de 72h sigue abierta): 180
