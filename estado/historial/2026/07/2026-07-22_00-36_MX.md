...
**Generado:** 2026-07-22 06:36 UTC (00:36 UTC-6)
...
| Hora de la medición | 2026-07-22 06:36 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 7.8, muro 3/5 (breach) y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.8 | 8.5 | 10.8 | 25.4 | P20 |
| Muro de los 5 | 3 | 2.4 | 1.9 | 3 | P100 |
| Silent Trigger | activo | 75% ciclos | 53% ciclos | — | — |
| Asertividad viva | 44% | 31% | — | — | — |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M6 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 14 | ~9 días |
...
| alfa2 | _en vivo · 161 ciclos · 30848 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,188
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,835
...
| Aciertos / Fallos (vivos) | 2,188 / 2,835 | — | — aciertos |
...
*Ciclos totales: 115 · Sentinel Omega · Fractal Core Research*
