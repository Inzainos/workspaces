...
**Generado:** 2026-07-17 17:19 UTC (11:19 UTC-6)
...
| Hora de la medición | 2026-07-17 17:19 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 8.2, muro 3/5 (breach) y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.2 | 10.6 | 11.6 | 25.4 | P1 |
| Muro de los 5 | 3 | 1.5 | 1.4 | 3 | P100 |
| Silent Trigger | activo | 48% ciclos | 37% ciclos | — | — |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 17 | ~9 días |
...
| alfa2 | _en vivo · 120 ciclos · 22913 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 1.00 |
| beta1 | 99.9% | 66.3% | — | 1.22 |
| beta2 | 99.6% | 23.3% | — | 1.00 |
| delta | 99.9% | 27.3% | — | 1.00 |
| omega | 99.9% | 76.7% | — | 0.99 |
| padre | 99.3% | 50.0% | 2.6% | 0.77 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,804
...
| Aciertos / Fallos (vivos) | 2,177 / 2,804 | — | — aciertos |
