...
**Generado:** 2026-07-08 14:29 UTC (08:29 UTC-6)
...
| Hora de la medición | 2026-07-08 14:29 UTC | |
...
| **87%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 8 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 119 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 7 | ~9 días |
...
- ACIERTO — avisó y el evento ocurrió: 691
- FALLO — el evento ocurrió sin aviso (lo más castigado): 1,324
- PENDIENTES (avisos cuya ventana de 72h sigue abierta): 57
