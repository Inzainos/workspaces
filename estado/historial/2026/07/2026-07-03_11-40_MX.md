...
**Generado:** 2026-07-03 17:40 UTC (11:40 UTC-6)
...
| Hora de la medición | 2026-07-03 12:14 UTC | |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 8 | ~9 días |
...
| beta2 | 467 | 21,720 | 1.50 `▓▓▓▓▓▓` |
| delta | 380 | 15,727 | 1.50 `▓▓▓▓▓▓` |
| padre | 2,249 | 49,001 | 1.00 `▓▓▓▓░░` |
...
- PENDIENTES (avisos cuya ventana de 72h sigue abierta): 3
...
*Ciclos totales: 3 · Sentinel Omega · Fractal Core Research*
