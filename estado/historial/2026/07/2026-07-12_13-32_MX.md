...
**Generado:** 2026-07-12 19:32 UTC (13:32 UTC-6)
...
| Hora de la medición | 2026-07-12 19:14 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.2, muro 1/5 y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.2 | 11.3 | 12.0 | 25.4 | P41 |
| Muro de los 5 | 1 | 0.9 | 1.4 | 3 | P51 |
| Silent Trigger | inactivo | 54% ciclos | 33% ciclos | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M5 | **Ghost Nankai-Tokai** (34.5, 138.0) · nodo 57 | 310 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M6 | **Nayarit-Sinaloa** (22.0, -105.5) · nodo 50 | 24 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Ghost East Pacific Rise N** (10.0, -104.0) · nodo 91 | 60 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 6 | ~9 días |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,759
- PENDIENTE — ventana de 72h aún abierta: 30
...
| Aciertos / Fallos (vivos) | 2,176 / 2,759 | — | — aciertos |
| Pendientes de auditoría | 30 | — | — |
...
*Ciclos totales: 166 · Sentinel Omega · Fractal Core Research*
