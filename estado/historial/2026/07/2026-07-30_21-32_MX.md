...
**Generado:** 2026-07-31 03:32 UTC (21:32 UTC-6)
...
| Hora de la medición | 2026-07-31 03:32 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.4, muro 2/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.4 | 9.7 | 10.5 | 25.4 | P4 |
| Muro de los 5 | 2 | 2.0 | 2.1 | 3 | P65 |
| Silent Trigger | activo | 70% ciclos | 57% ciclos | — | — |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 50 | ~8 días |
...
| **80%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 103 | ~8 días |
...
| alfa2 | _en vivo · 237 ciclos · 45058 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,907
...
| Aciertos / Fallos (vivos) | 2,196 / 2,907 | — | — aciertos |
