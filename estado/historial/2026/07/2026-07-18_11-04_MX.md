...
**Generado:** 2026-07-18 17:04 UTC (11:04 UTC-6)
...
| Hora de la medición | 2026-07-18 17:04 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.9, muro 3/5 (breach) y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.9 | 10.0 | 11.8 | 25.4 | P2 |
| Muro de los 5 | 3 | 1.7 | 1.6 | 3 | P100 |
| Silent Trigger | activo | 55% ciclos | 48% ciclos | — | — |
| Asertividad viva | 44% | 3% | — | — | — |
...
| **89%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 17 | ~9 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.99 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 1.16 `▓▓▓▓▓░` |
| beta2 | 467 | 21,720 | 0.92 `▓▓▓▓░░` |
| delta | 380 | 15,727 | 0.92 `▓▓▓▓░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.72 `▓▓▓░░░` |
| alfa2 | _en vivo · 130 ciclos · 24835 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 43.6% |
| **Últimos 7 días** (viva) | 2.7% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.99 |
| beta1 | 99.9% | 66.3% | — | 1.16 |
| beta2 | 99.6% | 23.3% | — | 0.92 |
| delta | 99.9% | 27.3% | — | 0.92 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 49.5% | 2.7% | 0.72 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,813
...
| Asertividad viva | 43.6% | — | — |
| Aciertos / Fallos (vivos) | 2,177 / 2,813 | — | — aciertos |
| Pendientes de auditoría | 30 | — | — |
| Pesos de bots | alfa1 0.99, beta1 1.16, beta2 0.92, delta 0.92, omega 1.00, padre 0.72 | — | primera bitácora |
...
*Ciclos totales: 94 · Sentinel Omega · Fractal Core Research*
