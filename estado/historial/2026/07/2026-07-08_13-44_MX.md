...
**Generado:** 2026-07-08 19:44 UTC (13:44 UTC-6)
...
| Hora de la medición | 2026-07-08 19:44 UTC | |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 16 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 119 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
...
| **Viva** (operación real, auditada) | 44.2% |
...
- ACIERTO — avisó y el evento ocurrió: 694
- FALLO — el evento ocurrió sin aviso (lo más castigado): 1,324
- PENDIENTES (avisos cuya ventana de 72h sigue abierta): 56
