...
**Generado:** 2026-07-20 21:17 UTC (15:17 UTC-6)
...
| Hora de la medición | 2026-07-20 21:17 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 9.5, muro 3/5 (breach) y firma máxima 96%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.5 | 8.8 | 11.0 | 25.4 | P42 |
| Muro de los 5 | 3 | 2.2 | 1.8 | 3 | P100 |
| Silent Trigger | activo | 75% ciclos | 56% ciclos | — | — |
...
|---|---|---|---|---|
| **96%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 130 | ~8 días |
...
| alfa2 | _en vivo · 149 ciclos · 28509 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,180
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,832
...
| Aciertos / Fallos (vivos) | 2,180 / 2,832 | — | — aciertos |
...
*Ciclos totales: 103 · Sentinel Omega · Fractal Core Research*
