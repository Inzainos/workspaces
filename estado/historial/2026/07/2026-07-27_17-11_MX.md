...
**Generado:** 2026-07-27 23:11 UTC (17:11 UTC-6)
...
| Hora de la medición | 2026-07-27 23:11 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.6, muro 1/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.6 | 10.6 | 11.0 | 25.4 | P18 |
| Muro de los 5 | 1 | 2.1 | 2.2 | 3 | P16 |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 49 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 20 | ~8 días |
...
| alfa2 | _en vivo · 212 ciclos · 40536 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,879
...
| Aciertos / Fallos (vivos) | 2,194 / 2,879 | — | — aciertos |
