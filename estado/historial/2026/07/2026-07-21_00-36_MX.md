...
**Generado:** 2026-07-21 06:36 UTC (00:36 UTC-6)
...
| Hora de la medición | 2026-07-21 06:36 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 12.1, muro 3/5 (breach) y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 12.1 | 8.9 | 11.0 | 25.4 | P75 |
| Muro de los 5 | 3 | 2.3 | 1.9 | 3 | P100 |
| Silent Trigger | activo | 78% ciclos | 57% ciclos | — | — |
| Asertividad viva | 43% | 11% | — | — | — |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 130 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 17 | ~9 días |
...
| **83%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 155 | ~8 días |
...
| alfa2 | _en vivo · 152 ciclos · 29091 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 43.5% |
| **Últimos 7 días** (viva) | 10.8% |
...
- ACIERTO — avisó y el evento ocurrió: 2,181
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,833
...
| Asertividad viva | 43.5% | — | — |
| Aciertos / Fallos (vivos) | 2,181 / 2,833 | — | — aciertos |
...
*Ciclos totales: 106 · Sentinel Omega · Fractal Core Research*
