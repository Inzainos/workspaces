...
**Generado:** 2026-07-25 09:57 UTC (03:57 UTC-6)
...
| Hora de la medición | 2026-07-25 09:56 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 13.7, muro 3/5 (breach) y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 13.7 | 9.5 | 11.2 | 25.4 | P76 |
| Muro de los 5 | 3 | 2.6 | 2.3 | 3 | P100 |
| Silent Trigger | activo | 61% ciclos | 54% ciclos | — | — |
...
| **89%** `▓▓▓▓░` | SISMO_M5 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 20 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 18 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 16 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.97 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 1.05 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.78 `▓▓▓░░░` |
| delta | 380 | 15,727 | 0.78 `▓▓▓░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.63 `▓▓▓░░░` |
| alfa2 | _en vivo · 187 ciclos · 35847 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 34.3% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.97 |
| beta1 | 99.9% | 66.3% | — | 1.05 |
| beta2 | 99.5% | 23.3% | — | 0.78 |
| delta | 99.9% | 27.3% | — | 0.78 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 48.4% | 34.3% | 0.63 |
...
- ACIERTO — avisó y el evento ocurrió: 2,194
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,857
...
| Aciertos / Fallos (vivos) | 2,194 / 2,857 | — | — aciertos |
| Pendientes de auditoría | 26 | — | — |
| Pesos de bots | alfa1 0.97, beta1 1.05, beta2 0.78, delta 0.78, omega 1.00, padre 0.63 | — | primera bitácora |
...
*Ciclos totales: 91 · Sentinel Omega · Fractal Core Research*
