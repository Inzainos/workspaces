...
**Generado:** 2026-07-30 17:43 UTC (11:43 UTC-6)
...
| Hora de la medición | 2026-07-30 17:43 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.5, muro 1/5 y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.5 | 10.0 | 10.6 | 25.4 | P5 |
| Muro de los 5 | 1 | 2.0 | 2.1 | 3 | P19 |
| Silent Trigger | inactivo | 64% ciclos | 56% ciclos | — | — |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Tlaxcala Acuífero** (19.3, -98.2) · nodo 118 | 31 | ~8 días |
| **83%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 14 | ~8 días |
| **83%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 9 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **Guerrero Interior** (17.8, -99.5) · nodo 48 | 13 | ~8 días |
...
| alfa2 | _en vivo · 233 ciclos · 44340 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,902
...
| Aciertos / Fallos (vivos) | 2,196 / 2,902 | — | — aciertos |
