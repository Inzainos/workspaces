...
**Generado:** 2026-07-18 15:01 UTC (09:01 UTC-6)
...
| Hora de la medición | 2026-07-18 15:01 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 7.0, muro 3/5 (breach) y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.0 | 10.0 | 11.8 | 25.4 | P2 |
| Muro de los 5 | 3 | 1.7 | 1.6 | 3 | P100 |
| Silent Trigger | activo | 54% ciclos | 47% ciclos | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 17 | ~9 días |
...
| alfa2 | _en vivo · 129 ciclos · 24644 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,811
- PENDIENTE — ventana de 72h aún abierta: 31
...
| Aciertos / Fallos (vivos) | 2,177 / 2,811 | — | — aciertos |
| Pendientes de auditoría | 31 | — | — |
...
*Ciclos totales: 93 · Sentinel Omega · Fractal Core Research*
