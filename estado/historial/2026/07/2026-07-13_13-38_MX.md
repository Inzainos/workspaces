...
**Generado:** 2026-07-13 19:38 UTC (13:38 UTC-6)
...
| Hora de la medición | 2026-07-13 19:38 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.9, muro 1/5 y firma máxima 88%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.9 | 11.1 | 12.0 | 25.4 | P29 |
| Muro de los 5 | 1 | 0.9 | 1.4 | 3 | P52 |
| Silent Trigger | inactivo | 55% ciclos | 33% ciclos | — | — |
...
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 136 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 15 | ~9 días |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,768
...
| Aciertos / Fallos (vivos) | 2,176 / 2,768 | — | — aciertos |
...
*Ciclos totales: 174 · Sentinel Omega · Fractal Core Research*
