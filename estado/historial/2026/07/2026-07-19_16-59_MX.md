...
**Generado:** 2026-07-19 22:59 UTC (16:59 UTC-6)
...
| Hora de la medición | 2026-07-19 22:59 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.1, muro 3/5 (breach) y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.1 | 9.1 | 11.2 | 25.4 | P2 |
| Muro de los 5 | 3 | 2.1 | 1.8 | 3 | P100 |
| Silent Trigger | activo | 70% ciclos | 54% ciclos | — | — |
...
| **84%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 155 | ~8 días |
...
| alfa2 | _en vivo · 143 ciclos · 27357 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,824
- PENDIENTE — ventana de 72h aún abierta: 32
...
| Aciertos / Fallos (vivos) | 2,177 / 2,824 | — | — aciertos |
| Pendientes de auditoría | 32 | — | — |
...
*Ciclos totales: 97 · Sentinel Omega · Fractal Core Research*
