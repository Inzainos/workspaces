...
**Generado:** 2026-07-15 02:55 UTC (20:55 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **14.5** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-07-15 02:55 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 14.5, muro 1/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 14.5 | 12.4 | 11.9 | 25.4 | P89 |
| Muro de los 5 | 1 | 1.0 | 1.4 | 3 | P53 |
| Silent Trigger | inactivo | 24% ciclos | 33% ciclos | — | — |
...
| **90%** `▓▓▓▓▓` | SISMO_M5 | **Ghost East Pacific Rise N** (10.0, -104.0) · nodo 91 | 60 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 47 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 391 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 394 | ~8 días |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,781
...
| Aciertos / Fallos (vivos) | 2,176 / 2,781 | — | — aciertos |
...
*Ciclos totales: 187 · Sentinel Omega · Fractal Core Research*
