...
**Generado:** 2026-07-11 15:01 UTC (09:01 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **11.4** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-07-11 15:01 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.4, muro 1/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.4 | 12.1 | 12.1 | 25.4 | P40 |
| Muro de los 5 | 1 | 1.3 | 1.4 | 3 | P50 |
| Silent Trigger | inactivo | 33% ciclos | 33% ciclos | — | — |
| Asertividad viva | 62% | 58% | — | — | — |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 136 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Nayarit-Sinaloa** (22.0, -105.5) · nodo 50 | 24 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Ghost East Pacific Rise N** (10.0, -104.0) · nodo 91 | 60 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Ghost Nankai-Tokai** (34.5, 138.0) · nodo 57 | 310 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 6 | ~9 días |
...
| **Viva** (operación real, auditada) | 61.6% |
| **Últimos 7 días** (viva) | 58.3% |
...
- ACIERTO — avisó y el evento ocurrió: 180,760
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,749
- PENDIENTES (avisos cuya ventana de 72h sigue abierta): 28
...
| Asertividad viva | 61.6% | — | — |
| Aciertos / Fallos (vivos) | 77 / 48 | — | — aciertos |
...
*Ciclos totales: 154 · Sentinel Omega · Fractal Core Research*
