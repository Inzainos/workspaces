...
**Generado:** 2026-07-10 04:26 UTC (22:26 UTC-6)
...
| Precursores detectados | 3 | ["SEISMIC_CLUSTER", "SCHUMANN", "TSUNAMI"] |
| Hora de la medición | 2026-07-03 21:46 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 11.7, muro 3/5 (breach) y firma máxima 86%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.7 | 12.1 | 61.0 | 130.9 | P2 |
| Muro de los 5 | 3 | 3.0 | 3.0 | 3 | P100 |
| Silent Trigger | inactivo | 50% ciclos | 99% ciclos | — | — |
...
|---|---|---|---|---|
| **86%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 49 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 67 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M4 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 120 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 44 | ~8 días |
| **83%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 17 | ~9 días |
...
|---|---|---|---|---|
| SISMO_M4 | **8.3 días** | 14.0 d | 1.0 d | 118 |
| SISMO_M5 | **8.0 días** | 14.0 d | 1.0 d | 108 |
| SISMO_M6 | **8.6 días** | 14.0 d | 1.0 d | 108 |
| SISMO_M7 | **10.5 días** | 14.0 d | 1.0 d | 107 |
...
|---|---|---|---|
| Tormenta geomagnética en las últimas 72h | 2.07 | 0.10 | más presente cuando el evento llega PRONTO |
| Índice Kp máximo (tormenta geomagnética) | 3.74 | 0.53 | más presente cuando el evento llega PRONTO |
| Gas volcánico SO₂ en la ventana (kilotones) | 83.83 | 15.04 | más presente cuando el evento llega PRONTO |
| Índice Kp promedio | 0.35 | 0.10 | más presente cuando el evento llega PRONTO |
| Erupciones registradas en la ventana | 1.19 | 0.35 | más presente cuando el evento llega PRONTO |
| Gas volcánico SO₂ (90 días) | 434.87 | 219.71 | más presente cuando el evento llega PRONTO |
...
|---|---|---|---|
| alfa1 | 180 | 237,167 | 1.50 `▓▓▓▓▓▓` |
| beta1 | 851 | 237,166 | 1.50 `▓▓▓▓▓▓` |
| beta2 | 701 | 111,509 | 1.50 `▓▓▓▓▓▓` |
| delta | 623 | 79,688 | 1.50 `▓▓▓▓▓▓` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 4,304 | 237,166 | 1.00 `▓▓▓▓░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 97.5% |
| **Viva** (operación real, auditada) | 36.6% |
| **Últimos 7 días** (viva) | 0.0% |
...
| 2 | 🌎 **SISMO_M4** | alfa1 | Ghost Puebla-Veracruz | 18,539 | ✅ consolidada | — |
| 3 | 🌎 **SISMO_M4** | alfa1 | Colombia-Ecuador | 17,830 | ✅ consolidada | — |
| 4 | 🌎 **SISMO_M4** | alfa1 | Ghost Ryukyu | 14,168 | ✅ consolidada | — |
| 5 | 🌎 **SISMO_M4** | omega | Baja California Sur | 13,500 | ✅ consolidada | — |
| 6 | 🌎 **SISMO_M5** | alfa1 | GeoBat PNG Rabaul | 13,349 | ✅ consolidada | — |
| 7 | 🌎 **SISMO_M4** | omega | Islandia Rift | 13,057 | ✅ consolidada | — |
| 8 | 🌎 **SISMO_M4** | alfa1 | GeoBat San Andreas Creep | 12,540 | ✅ consolidada | — |
| 9 | 🌎 **SISMO_M4** | alfa1 | Baja California Sur | 10,659 | ✅ consolidada | — |
| 10 | 🌎 **SISMO_M5** | omega | Perú Subducción | 10,587 | ✅ consolidada | — |
...
| alfa1 | Ghost Puebla-Veracruz (19.0, -97.5) | 18,539 | ✅ consolidada | — |
| alfa1 | Colombia-Ecuador (2.0, -78.0) | 17,830 | ✅ consolidada | — |
| alfa1 | Ghost Ryukyu (26.0, 128.0) | 14,168 | ✅ consolidada | — |
...
| Bot | Zona (nodo de la malla) | Veces vista | Estado | Aviso típico |
|---|---|---|---|---|
| alfa1 | GeoBat PNG Rabaul (-4.3, 152.2) | 13,349 | ✅ consolidada | — |
| omega | Perú Subducción (-12.0, -77.0) | 10,587 | ✅ consolidada | — |
| alfa1 | Japón Nankai (33.0, 135.0) | 10,160 | ✅ consolidada | — |
| alfa1 | Chiapas Subducción (14.8, -92.5) | 8,671 | ✅ consolidada | — |
| alfa1 | Baja California Sur (24.1, -110.0) | 7,988 | ✅ consolidada | — |

### 🌎 SISMO_M6

| Bot | Zona (nodo de la malla) | Veces vista | Estado | Aviso típico |
|---|---|---|---|---|
| alfa1 | Colombia-Ecuador (2.0, -78.0) | 1,342 | ✅ consolidada | — |
| alfa1 | GeoBat Cascadia Fluidos (45.5, -124.5) | 1,191 | ✅ consolidada | — |
| alfa1 | Baja California Sur (24.1, -110.0) | 987 | ✅ consolidada | — |
| alfa1 | Ghost Chiapas Interior (15.5, -93.0) | 961 | ✅ consolidada | — |
...
| Bot | Zona (nodo de la malla) | Veces vista | Estado | Aviso típico |
|---|---|---|---|---|
| alfa1 | GeoBat San Andreas Creep (36.0, -120.5) | 253 | ✅ consolidada | — |
| alfa1 | Baja California Sur (24.1, -110.0) | 238 | ✅ consolidada | — |
| alfa1 | Baja California Sur (24.1, -110.0) | 159 | ✅ consolidada | — |
| omega | Japón Nankai (33.0, 135.0) | 111 | ✅ consolidada | — |
| alfa1 | Perú Subducción (-12.0, -77.0) | 89 | ✅ consolidada | — |
...
|---|---:|---|---:|---|
| DESGAS+SISMICO | 77 | DESGAS+SISMICO | 43% | **INDIFERENTE** |
| SISMICO | 68 | SISMICO | 100% | **ORDEN UNICO OBSERVADO** |
| DESGAS+FINANCIERO+SISMICO | 32 | DESGAS+FINANCIERO+SISMICO | 38% | **INDIFERENTE** |
...
- ACIERTO — avisó y el evento ocurrió: 178,651
- FALLO — el evento ocurrió sin aviso (lo más castigado): 116
- PENDIENTES (avisos cuya ventana de 72h sigue abierta): 0
...
| Asertividad viva | 36.6% | 99.9% | -63.3% |
| Aciertos / Fallos (vivos) | 67 / 116 | 178,651 / 116 | -178584 aciertos |
| Pendientes de auditoría | 0 | 0 | +0 |
| Pesos de bots | 6 bots | — | sin movimiento |

*Asertividad viva, últimos cortes: 100% → 100%*
...
*Ciclos totales: 184 · Sentinel Omega · Fractal Core Research*
