...
**Generado:** 2026-07-17 21:03 UTC (15:03 UTC-6)
...
| Hora de la medición | 2026-07-17 21:03 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 8.0, muro 3/5 (breach) y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.0 | 10.5 | 11.6 | 25.4 | P1 |
| Muro de los 5 | 3 | 1.6 | 1.4 | 3 | P100 |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Nankai-Tokai** (34.5, 138.0) · nodo 57 | 310 | ~8 días |
...
| alfa2 | _en vivo · 122 ciclos · 23303 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,806
...
| Aciertos / Fallos (vivos) | 2,177 / 2,806 | — | — aciertos |
