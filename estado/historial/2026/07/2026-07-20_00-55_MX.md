...
**Generado:** 2026-07-20 06:55 UTC (00:55 UTC-6)
...
| Hora de la medición | 2026-07-20 06:55 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.0, muro 3/5 (breach) y firma máxima 91%.
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 106 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 82 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 14 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 21 | ~8 días |
...
| alfa2 | _en vivo · 145 ciclos · 27741 pases observados_ | — | 1.00 `▓▓▓▓░░` |
