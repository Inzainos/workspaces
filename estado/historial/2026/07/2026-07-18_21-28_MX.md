...
**Generado:** 2026-07-19 03:28 UTC (21:28 UTC-6)
...
| Hora de la medición | 2026-07-19 03:28 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 7.3, muro 3/5 (breach) y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.3 | 9.7 | 11.6 | 25.4 | P9 |
| Muro de los 5 | 3 | 1.8 | 1.6 | 3 | P100 |
| Silent Trigger | activo | 57% ciclos | 50% ciclos | — | — |
...
| **89%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 15 | ~9 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 155 | ~8 días |
...
| alfa2 | _en vivo · 134 ciclos · 25602 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,818
...
| Aciertos / Fallos (vivos) | 2,177 / 2,818 | — | — aciertos |
