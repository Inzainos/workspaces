...
**Generado:** 2026-09-21 02:34 UTC (20:34 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **8.2** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-09-21 02:34 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.2, muro 2/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.2 | 15.1 | 13.3 | 61.2 | P22 |
| Muro de los 5 | 2 | 1.6 | 1.7 | 3 | P98 |
| Silent Trigger | activo | 61% ciclos | 64% ciclos | — | — |
| Asertividad viva | 35% | — | — | — | — |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 137 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 22 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 20 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Ghost Baja-Sonora** (28.0, -113.0) · nodo 55 | 110 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 8 | ~9 días |
...
| alfa2 | _en vivo · 21 ciclos · 3146 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Fallos** | 36034 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 21.7% `▓▓▓░░░░░░░░░` |
| **Predicciones auditadas** | 46000 |
| **Pendientes (ventana abierta)** | 864 |
...
|-----|----------|------|-----------|------------------------|
| omega | 3038/7625 | 40% `▓▓▓░░░░░` | 0.41 | 3.8 |
| beta1 | 2313/7625 | 30% `▓▓░░░░░░` | 0.31 | 3.8 |
| padre | 1711/7625 | 22% `▓▓░░░░░░` | 0.23 | 3.8 |
| alfa1 | 1546/7625 | 20% `▓▓░░░░░░` | 0.21 | 3.8 |
| delta | 818/7625 | 11% `▓░░░░░░░` | 0.11 | 3.8 |
| beta2 | 531/7625 | 7% `▓░░░░░░░` | 0.07 | 3.8 |
| jupiter | 7/125 | 6% `░░░░░░░░` | 0.21 | 231.7 |
| alfa2 | 2/125 | 2% `░░░░░░░░` | 0.30 | 231.7 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### PADRE — alert — (—)

- **Predicción:** 2026-09-20 08:29 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-20 08:29:02
...
- **Predicción:** 2026-09-20 08:29 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-20 08:29:01
...
- **Predicción:** 2026-09-20 08:29 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-20 08:29:00
- **Verdad registrada:** 2025-01-13 14:17|nodo21|M4.3
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
_... y 9956 aciertos más en los últimos 30 días_
...
*Ciclos totales: 245 · Sentinel Omega · Fractal Core Research*
