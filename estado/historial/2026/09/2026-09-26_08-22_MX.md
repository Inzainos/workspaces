...
**Generado:** 2026-09-26 14:22 UTC (08:22 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **9.9** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-09-26 14:22 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.9, muro 2/5 y firma máxima 89%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.9 | 9.5 | 13.2 | 61.2 | P57 |
| Muro de los 5 | 2 | 1.6 | 1.6 | 2 | P100 |
| Silent Trigger | activo | 57% ciclos | 58% ciclos | — | — |
| Asertividad viva | 34% | — | — | — | — |
...
|---|---|---|---|---|
| **89%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 25 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 10 | ~8 días |
| **83%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 12 | ~8 días |
| **80%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 5 | ~9 días |
| **80%** `▓▓▓▓░` | SISMO_M5 | **San Andreas S** (33.9, -116.5) · nodo 18 | 42 | ~8 días |
...
| alfa2 | _en vivo · 15 ciclos · 2131 pases observados_ | — | 0.30 `▓░░░░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 1,072
...
| **Pendientes (ventana abierta)** | 1072 |
