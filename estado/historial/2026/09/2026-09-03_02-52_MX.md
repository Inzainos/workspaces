...
**Generado:** 2026-09-03 08:52 UTC (02:52 UTC-6)
...
| Hora de la medición | 2026-09-03 08:50 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.2, muro 2/5 y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.2 | 9.3 | 10.4 | 27.5 | P26 |
| Muro de los 5 | 2 | 1.4 | 2.4 | 3 | P36 |
| Silent Trigger | activo | 39% ciclos | 76% ciclos | — | — |
| Asertividad viva | 40% | — | — | — | — |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Ryukyu** (26.0, 128.0) · nodo 82 | 48 | ~8 días |
...
| alfa2 | _en vivo · 5 ciclos · 875 pases observados_ | — | 0.30 `▓░░░░░` |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.5% | — | 0.31 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 63.2% | — | 0.31 |
| beta2 | 99.1% | 22.2% | — | 0.30 |
| delta | 99.3% | 26.1% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 66.9% | — | 0.31 |
| padre | 99.1% | 43.5% | — | 0.31 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,405
...
| Aciertos / Fallos (vivos) | 2,279 / 3,405 | — | — aciertos |
