...
**Generado:** 2026-09-08 04:02 UTC (22:02 UTC-6)
...
| Hora de la medición | 2026-09-08 04:02 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.6, muro 1/5 y firma máxima 86%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.6 | 8.4 | 10.1 | 27.5 | P53 |
| Muro de los 5 | 1 | 1.7 | 2.4 | 3 | P14 |
| Silent Trigger | inactivo | 72% ciclos | 82% ciclos | — | — |
| Asertividad viva | 38% | — | — | — | — |
...
|---|---|---|---|---|
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 27 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Oaxaca Costa** (15.9, -97.1) · nodo 2 | 5 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 20 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 7 | ~8 días |
...
| **Viva** (operación real, auditada) | 37.8% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.8% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 60.5% | — | 0.30 |
| beta2 | 98.8% | 21.3% | — | 0.30 |
| delta | 98.9% | 24.9% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 59.3% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,755
...
| Asertividad viva | 37.8% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,755 | — | — aciertos |
