...
**Generado:** 2026-09-15 20:22 UTC (14:22 UTC-6)
...
|---|---|---|
| Fantasma | 🔴 **58.0** `▓▓▓▓▓▓▓▓▓▓` | condiciones muy cargadas |
...
| Hora de la medición | 2026-09-15 20:22 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 58.0, muro 1/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 58.0 | 13.4 | 11.9 | 61.2 | P99 |
| Muro de los 5 | 1 | 1.5 | 1.9 | 3 | P38 |
| Silent Trigger | inactivo | 47% ciclos | 56% ciclos | — | — |
| Asertividad viva | 36% | — | — | — | — |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M7 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 5 | ~12 días |
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 295 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 22 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 18 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mid-Atlantic S** (10.0, -40.0) · nodo 80 | 146 | ~8 días |
...
| alfa2 | _en vivo · 18 ciclos · 2723 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 36.0% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.6% | 34.5% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.5% | 58.3% | — | 0.30 |
| beta2 | 98.6% | 20.5% | — | 0.30 |
| delta | 98.5% | 24.0% | — | 0.30 |
| jupiter | 1.6% | 1.6% | — | 0.30 |
| omega | 99.8% | 54.0% | — | 0.30 |
| padre | 98.9% | 41.2% | — | 0.30 |
...
- ACIERTO — avisó y el evento ocurrió: 2,283
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,057
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 544
...
| Asertividad viva | 36.0% | — | — |
| Aciertos / Fallos (vivos) | 2,283 / 4,057 | — | — aciertos |
| Pendientes de auditoría | 544 | — | — |
...
| **Fallos** | 32787 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 28.8% `▓▓▓░░░░░░░░░` |
| **Predicciones auditadas** | 46046 |
| **Pendientes (ventana abierta)** | 544 |
...
|-----|----------|------|-----------|------------------------|
| omega | 3740/7626 | 49% `▓▓▓▓░░░░` | 0.50 | 3.9 |
| beta1 | 2938/7626 | 39% `▓▓▓░░░░░` | 0.39 | 3.9 |
| padre | 2288/7664 | 30% `▓▓░░░░░░` | 0.30 | 4.2 |
| alfa1 | 2038/7626 | 27% `▓▓░░░░░░` | 0.27 | 3.9 |
| delta | 1175/7626 | 15% `▓░░░░░░░` | 0.16 | 3.9 |
| beta2 | 1078/7626 | 14% `▓░░░░░░░` | 0.14 | 3.9 |
| jupiter | 2/126 | 2% `░░░░░░░░` | 0.21 | 233.5 |
| alfa2 | 0/126 | 0% `░░░░░░░░` | 0.30 | 233.5 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### PADRE — alert — (—)

- **Predicción:** 2026-09-15 08:31 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-15 08:31:44
...
- **Predicción:** 2026-09-15 08:31 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-15 08:31:43
...
_... y 13249 aciertos más en los últimos 30 días_
...
*Ciclos totales: 207 · Sentinel Omega · Fractal Core Research*
