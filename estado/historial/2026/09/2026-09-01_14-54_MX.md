...
**Generado:** 2026-09-01 20:54 UTC (14:54 UTC-6)
...
| Hora de la medición | 2026-09-01 20:54 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.5, muro 1/5 y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.5 | 8.8 | 10.1 | 27.5 | P50 |
| Muro de los 5 | 1 | 1.6 | 2.3 | 3 | P18 |
| Silent Trigger | inactivo | 58% ciclos | 78% ciclos | — | — |
| Asertividad viva | 40% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 5637 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 40% |
| **Ganancia** (sistema ÷ tasa base) | 0.42× |
...
|---|---|---|---|---|
| **90%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 11 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 83 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 228 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 11 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 32 | ~8 días |
...
| alfa2 | _en vivo · 11 ciclos · 1955 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 40.4% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.7% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 63.6% | — | 0.30 |
| beta2 | 99.1% | 22.4% | — | 0.30 |
| delta | 99.3% | 26.2% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 68.0% | — | 0.30 |
| padre | 99.1% | 43.6% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,357
...
| Asertividad viva | 40.4% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,357 | — | — aciertos |
