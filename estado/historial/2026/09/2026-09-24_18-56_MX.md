...
**Generado:** 2026-09-25 00:56 UTC (18:56 UTC-6)
...
| Hora de la medición | 2026-09-25 00:56 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.8, muro 1/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.8 | 8.7 | 12.8 | 61.2 | P76 |
| Muro de los 5 | 1 | 1.8 | 1.7 | 2 | P33 |
| Silent Trigger | inactivo | 75% ciclos | 67% ciclos | — | — |
| Asertividad viva | 34% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 6821 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 34% |
| **Ganancia** (sistema ÷ tasa base) | 0.35× |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Rivera Plate Deep** (20.5, -107.5) · nodo 125 | 248 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M6 | **Ghost East Pacific Rise N** (10.0, -104.0) · nodo 91 | 12 | ~9 días |
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 145 | ~8 días |
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 11 | ~9 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Ghost East Pacific Rise N** (10.0, -104.0) · nodo 91 | 60 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.30 `▓░░░░░` |
| beta1 | 494 | 49,001 | 0.30 `▓░░░░░` |
| beta2 | 467 | 21,720 | 0.30 `▓░░░░░` |
| delta | 380 | 15,727 | 0.30 `▓░░░░░` |
| omega | 360 | 179,235 | 0.30 `▓░░░░░` |
| padre | 2,249 | 49,001 | 0.30 `▓░░░░░` |
| alfa2 | _en vivo · 20 ciclos · 2827 pases observados_ | — | 0.30 `▓░░░░░` |
| jupiter | _en vivo · atención colectiva_ | — | 0.30 `▓░░░░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 99.3% |
| **Viva** (operación real, auditada) | 33.9% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.5% | 32.9% | — | 0.30 |
| alfa2 | 1.6% | 1.6% | — | 0.30 |
| beta1 | 99.4% | 55.3% | — | 0.30 |
| beta2 | 98.2% | 19.6% | — | 0.30 |
| delta | 98.0% | 22.9% | — | 0.30 |
| jupiter | 4.3% | 4.3% | — | 0.30 |
| omega | 99.8% | 47.9% | — | 0.30 |
| padre | 98.7% | 39.9% | — | 0.30 |
...
- ACIERTO — avisó y el evento ocurrió: 2,310
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,510
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 944
...
| Asertividad viva | 33.9% | — | — |
| Aciertos / Fallos (vivos) | 2,310 / 4,510 | — | — aciertos |
| Pendientes de auditoría | 944 | — | — |
| Pesos de bots | alfa1 0.30, alfa2 0.30, beta1 0.30, beta2 0.30, delta 0.30, jupiter 0.30, omega 0.30, padre 0.30 | — | primera bitácora |


## ✅ Aciertos y Predicciones Correctas

> El sistema también tiene victorias que celebrar. Esta sección documenta cuándo nuestras predicciones fueron correctas: qué anticipamos, con qué ventana nos jugamos el aviso y qué encontró el Juez al verificarlo.
...
| **Fallos** | 36557 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 20.4% `▓▓░░░░░░░░░░` |
| **Predicciones auditadas** | 45920 |
| **Pendientes (ventana abierta)** | 944 |

_La tasa se calcula solo sobre lo que el Juez ya resolvió; las pendientes aún no se sabe si aciertan._

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza | Ventana declarada (h) |
|-----|----------|------|-----------|------------------------|
| omega | 2897/7615 | 38% `▓▓▓░░░░░` | 0.39 | 3.4 |
| beta1 | 2200/7615 | 29% `▓▓░░░░░░` | 0.29 | 3.4 |
| padre | 1609/7615 | 21% `▓▓░░░░░░` | 0.21 | 3.4 |
| alfa1 | 1449/7615 | 19% `▓▓░░░░░░` | 0.19 | 3.4 |
| delta | 765/7615 | 10% `▓░░░░░░░` | 0.10 | 3.4 |
| beta2 | 432/7615 | 6% `░░░░░░░░` | 0.06 | 3.4 |
| jupiter | 8/115 | 7% `▓░░░░░░░` | 0.21 | 225.9 |
| alfa2 | 3/115 | 3% `░░░░░░░░` | 0.30 | 225.9 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### PADRE — alert — (—)

- **Predicción:** 2026-09-24 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-24 08:32:35
- **Verdad registrada:** 2025-01-04 12:36|nodo99|M4.2
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Predicción:** 2026-09-24 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-24 08:32:34
- **Verdad registrada:** 2025-01-05 14:04|nodo99|M4.4
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-24 08:32:34
- **Verdad registrada:** 2025-01-07 08:00|nodo99|M4.2
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-24 08:32:34
- **Verdad registrada:** 2025-01-08 11:16|nodo84|M4.3
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Predicción:** 2026-09-24 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-24 08:32:33
- **Verdad registrada:** 2025-01-13 14:17|nodo21|M4.3
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Predicción:** 2026-09-24 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-24 08:32:32
- **Verdad registrada:** 2025-01-17 19:59|nodo111|M3.3
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo

_... y 9353 aciertos más en los últimos 30 días_
...
*Ciclos totales: 264 · Sentinel Omega · Fractal Core Research*
