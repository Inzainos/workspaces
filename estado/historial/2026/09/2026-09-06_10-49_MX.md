...
**Generado:** 2026-09-06 16:49 UTC (10:49 UTC-6)
...
| Hora de la medición | 2026-09-06 16:49 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.6, muro 2/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.6 | 8.6 | 10.2 | 27.5 | P72 |
| Muro de los 5 | 2 | 1.8 | 2.4 | 3 | P42 |
| Silent Trigger | activo | 75% ciclos | 81% ciclos | — | — |
| Asertividad viva | 38% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 6013 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 38% |
| **Ganancia** (sistema ÷ tasa base) | 0.39× |
...
| **93%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 17 | ~9 días |
...
| alfa2 | _en vivo · 8 ciclos · 1436 pases observados_ | — | 0.30 `▓░░░░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 99.6% |
| **Viva** (operación real, auditada) | 37.9% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.9% | — | 0.31 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 60.7% | — | 0.31 |
| beta2 | 98.9% | 21.3% | — | 0.30 |
| delta | 98.9% | 25.0% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 59.7% | — | 0.31 |
| padre | 99.0% | 42.4% | — | 0.31 |
...
- ACIERTO — avisó y el evento ocurrió: 2,281
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,731
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 360
...
| Asertividad viva | 37.9% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,731 | — | — aciertos |
| Pendientes de auditoría | 360 | — | — |
