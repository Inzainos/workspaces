...
**Generado:** 2026-09-10 14:13 UTC (08:13 UTC-6)
...
| Hora de la medición | 2026-09-10 14:13 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.3, muro 1/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.3 | 9.4 | 9.8 | 21.3 | P72 |
| Muro de los 5 | 1 | 1.6 | 2.4 | 3 | P17 |
| Silent Trigger | inactivo | 56% ciclos | 78% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
| **93%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 174 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 43 | ~8 días |
...
| alfa2 | _en vivo · 7 ciclos · 1188 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 37.2% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.4% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 59.7% | — | 0.30 |
| beta2 | 98.7% | 21.0% | — | 0.30 |
| delta | 98.8% | 24.6% | — | 0.30 |
| jupiter | 1.0% | 1.0% | — | 0.30 |
| omega | 99.9% | 57.4% | — | 0.30 |
| padre | 99.0% | 41.9% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,858
...
| Asertividad viva | 37.2% | — | — |
| Aciertos / Fallos (vivos) | 2,282 / 3,858 | — | — aciertos |
