...
**Generado:** 2026-09-15 18:25 UTC (12:25 UTC-6)
...
|---|---|---|
| Fantasma | 🔴 **61.2** `▓▓▓▓▓▓▓▓▓▓` | condiciones muy cargadas |
...
| Hora de la medición | 2026-09-15 18:25 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 61.2, muro 2/5 y firma máxima 98%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 61.2 | 12.6 | 11.4 | 61.2 | P100 |
| Muro de los 5 | 2 | 1.5 | 1.9 | 3 | P72 |
| Silent Trigger | activo | 47% ciclos | 57% ciclos | — | — |
| Asertividad viva | 36% | — | — | — | — |
...
|---|---|---|---|---|
| **98%** `▓▓▓▓▓` | SISMO_M7 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 5 | ~12 días |
| **94%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 22 | ~9 días |
| **94%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 295 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 24 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 174 | ~8 días |
...
| alfa2 | _en vivo · 17 ciclos · 2576 pases observados_ | — | 0.30 `▓░░░░░` |
...
| omega | 99.8% | 54.1% | — | 0.30 |
| padre | 98.9% | 41.3% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,049
...
| Aciertos / Fallos (vivos) | 2,283 / 4,049 | — | — aciertos |
...
|-----|----------|------|-----------|------------------------|
| omega | 3740/7625 | 49% `▓▓▓▓░░░░` | 0.50 | 3.8 |
| beta1 | 2938/7625 | 39% `▓▓▓░░░░░` | 0.39 | 3.8 |
| padre | 2289/7664 | 30% `▓▓░░░░░░` | 0.30 | 4.2 |
| alfa1 | 2038/7625 | 27% `▓▓░░░░░░` | 0.27 | 3.8 |
| delta | 1175/7625 | 15% `▓░░░░░░░` | 0.16 | 3.8 |
| beta2 | 1078/7625 | 14% `▓░░░░░░░` | 0.14 | 3.8 |
| jupiter | 2/125 | 2% `░░░░░░░░` | 0.21 | 233.6 |
| alfa2 | 0/125 | 0% `░░░░░░░░` | 0.30 | 233.6 |
...
_... y 13250 aciertos más en los últimos 30 días_
...
*Ciclos totales: 206 · Sentinel Omega · Fractal Core Research*
