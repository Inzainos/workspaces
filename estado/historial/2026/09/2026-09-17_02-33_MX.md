...
**Generado:** 2026-09-17 08:33 UTC (02:33 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **13.1** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-09-17 08:31 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 13.1, muro 1/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 13.1 | 16.5 | 14.2 | 61.2 | P71 |
| Muro de los 5 | 1 | 1.5 | 1.8 | 3 | P38 |
| Silent Trigger | inactivo | 50% ciclos | 56% ciclos | — | — |
| Asertividad viva | 36% | — | — | — | — |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 7 | ~9 días |
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 119 | ~8 días |
| **90%** `▓▓▓▓▓` | SISMO_M7 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 5 | ~12 días |
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 8 | ~9 días |
...
| alfa2 | _en vivo · 12 ciclos · 1776 pases observados_ | — | 0.31 `▓░░░░░` |
...
| alfa2 | 0.7% | 0.7% | — | 0.31 |
| beta1 | 99.5% | 57.7% | — | 0.31 |
| beta2 | 98.5% | 20.3% | — | 0.30 |
| delta | 98.4% | 23.8% | — | 0.30 |
| jupiter | 2.2% | 2.2% | — | 0.31 |
| omega | 99.8% | 52.6% | — | 0.31 |
| padre | 98.9% | 41.0% | — | 0.31 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,153
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 584
...
| Aciertos / Fallos (vivos) | 2,291 / 4,153 | — | — aciertos |
| Pendientes de auditoría | 584 | — | — |
| Pesos de bots | alfa1 0.31, alfa2 0.31, beta1 0.31, beta2 0.30, delta 0.30, jupiter 0.31, omega 0.31, padre 0.31 | — | primera bitácora |
...
| **Fallos** | 34956 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 27.1% `▓▓▓░░░░░░░░░` |
| **Predicciones auditadas** | 47932 |
| **Pendientes (ventana abierta)** | 584 |
...
|-----|----------|------|-----------|------------------------|
| omega | 3716/7939 | 47% `▓▓▓▓░░░░` | 0.47 | 4.1 |
| beta1 | 2901/7939 | 37% `▓▓▓░░░░░` | 0.37 | 4.1 |
| padre | 2237/7959 | 28% `▓▓░░░░░░` | 0.28 | 4.3 |
| alfa1 | 1998/7939 | 25% `▓▓░░░░░░` | 0.26 | 4.1 |
| delta | 1134/7939 | 14% `▓░░░░░░░` | 0.15 | 4.1 |
| beta2 | 986/7939 | 12% `▓░░░░░░░` | 0.12 | 4.1 |
| jupiter | 3/139 | 2% `░░░░░░░░` | 0.21 | 233.9 |
| alfa2 | 1/139 | 1% `░░░░░░░░` | 0.30 | 233.9 |
...
_... y 12966 aciertos más en los últimos 30 días_
...
*Ciclos totales: 216 · Sentinel Omega · Fractal Core Research*
