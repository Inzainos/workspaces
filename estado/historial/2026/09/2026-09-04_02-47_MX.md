...
**Generado:** 2026-09-04 08:47 UTC (02:47 UTC-6)
...
| Hora de la medición | 2026-09-04 08:46 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.8 | 9.4 | 10.3 | 27.5 | P19 |
| Muro de los 5 | 2 | 1.5 | 2.4 | 3 | P38 |
| Silent Trigger | activo | 45% ciclos | 77% ciclos | — | — |
| Asertividad viva | 39% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 5821 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 39% |
...
| alfa2 | _en vivo · 5 ciclos · 888 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 39.2% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 36.8% | — | 0.31 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 62.2% | — | 0.31 |
| beta2 | 99.0% | 21.9% | — | 0.30 |
| delta | 99.1% | 25.6% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 63.7% | — | 0.31 |
| padre | 99.1% | 43.0% | — | 0.31 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,539
...
| Asertividad viva | 39.2% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,539 | — | — aciertos |
