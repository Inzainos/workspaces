...
**Generado:** 2026-09-11 04:05 UTC (22:05 UTC-6)
...
| Hora de la medición | 2026-09-11 04:05 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.3, muro 1/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.3 | 9.5 | 9.8 | 21.3 | P50 |
| Muro de los 5 | 1 | 1.5 | 2.3 | 3 | P19 |
| Silent Trigger | inactivo | 50% ciclos | 76% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 193 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 22 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M7 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 5 | ~12 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 81 | ~8 días |
...
| alfa2 | _en vivo · 10 ciclos · 1687 pases observados_ | — | 0.30 `▓░░░░░` |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.3% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 59.6% | — | 0.30 |
| beta2 | 98.7% | 20.9% | — | 0.30 |
| delta | 98.8% | 24.5% | — | 0.30 |
| jupiter | 1.0% | 1.0% | — | 0.30 |
| omega | 99.9% | 56.9% | — | 0.30 |
| padre | 99.0% | 41.8% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,882
...
| Aciertos / Fallos (vivos) | 2,282 / 3,882 | — | — aciertos |
