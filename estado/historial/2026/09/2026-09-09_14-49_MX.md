...
**Generado:** 2026-09-09 20:49 UTC (14:49 UTC-6)
...
| Hora de la medición | 2026-09-09 20:48 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.3 | 9.2 | 9.8 | 21.3 | P48 |
| Muro de los 5 | 1 | 1.7 | 2.4 | 3 | P16 |
| Silent Trigger | inactivo | 66% ciclos | 80% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
| **84%** `▓▓▓▓░` | SISMO_M5 | **Kamchatka** (53.0, 159.0) · nodo 20 | 16 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 119 | ~8 días |
...
| alfa2 | _en vivo · 13 ciclos · 2282 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 37.4% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.5% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 60.0% | — | 0.30 |
| beta2 | 98.8% | 21.1% | — | 0.30 |
| delta | 98.8% | 24.7% | — | 0.30 |
| jupiter | 1.0% | 1.0% | — | 0.30 |
| omega | 99.9% | 57.9% | — | 0.30 |
| padre | 99.0% | 42.0% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,826
...
| Asertividad viva | 37.4% | — | — |
| Aciertos / Fallos (vivos) | 2,282 / 3,826 | — | — aciertos |
