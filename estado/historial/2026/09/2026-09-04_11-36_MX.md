...
**Generado:** 2026-09-04 17:36 UTC (11:36 UTC-6)
...
| Hora de la medición | 2026-09-04 17:36 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.2, muro 2/5 y firma máxima 96%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.2 | 9.3 | 10.3 | 27.5 | P26 |
| Muro de los 5 | 2 | 1.5 | 2.4 | 3 | P39 |
| Silent Trigger | activo | 48% ciclos | 77% ciclos | — | — |
| Asertividad viva | 39% | — | — | — | — |
...
| **88%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 35 | ~9 días |
...
| **Viva** (operación real, auditada) | 38.7% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 36.5% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 61.6% | — | 0.30 |
| beta2 | 99.0% | 21.6% | — | 0.30 |
| delta | 99.1% | 25.4% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 62.2% | — | 0.30 |
| padre | 99.0% | 42.8% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,611
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 384
...
| Asertividad viva | 38.7% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,611 | — | — aciertos |
| Pendientes de auditoría | 384 | — | — |
