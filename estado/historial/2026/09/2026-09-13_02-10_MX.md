...
**Generado:** 2026-09-13 08:10 UTC (02:10 UTC-6)
...
| Hora de la medición | 2026-09-13 08:08 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.7, muro 1/5 y firma máxima 90%.
...
| Muro de los 5 | 1 | 1.4 | 2.2 | 3 | P28 |
| Silent Trigger | inactivo | 35% ciclos | 66% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
|---|---|---|---|---|
| **90%** `▓▓▓▓▓` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 37 | ~8 días |
...
| **82%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 58 | ~8 días |
...
| alfa2 | _en vivo · 5 ciclos · 837 pases observados_ | — | 0.30 `▓░░░░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 424
...
| **Fallos** | 32098 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 32.8% `▓▓▓▓░░░░░░░░` |
| **Predicciones auditadas** | 47756 |
| **Pendientes (ventana abierta)** | 424 |
...
|-----|----------|------|-----------|------------------------|
| omega | 4276/7911 | 54% `▓▓▓▓░░░░` | 0.55 | 3.3 |
| beta1 | 3406/7911 | 43% `▓▓▓░░░░░` | 0.43 | 3.3 |
| padre | 2723/7979 | 34% `▓▓▓░░░░░` | 0.34 | 3.9 |
| alfa1 | 2390/7911 | 30% `▓▓░░░░░░` | 0.31 | 3.3 |
| beta2 | 1433/7911 | 18% `▓░░░░░░░` | 0.18 | 3.3 |
| delta | 1429/7911 | 18% `▓░░░░░░░` | 0.18 | 3.3 |
...
_... y 15648 aciertos más en los últimos 30 días_
...
*Ciclos totales: 188 · Sentinel Omega · Fractal Core Research*
