...
**Generado:** 2026-09-02 14:15 UTC (08:15 UTC-6)
...
| Hora de la medición | 2026-09-02 14:15 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.8, muro 1/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.8 | 9.0 | 10.2 | 27.5 | P22 |
| Muro de los 5 | 1 | 1.4 | 2.4 | 3 | P18 |
| Silent Trigger | inactivo | 41% ciclos | 78% ciclos | — | — |
| Asertividad viva | 40% | — | — | — | — |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M6 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 11 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 32 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 83 | ~8 días |
...
| alfa2 | _en vivo · 7 ciclos · 1207 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 40.3% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.6% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 63.4% | — | 0.30 |
| beta2 | 99.1% | 22.3% | — | 0.30 |
| delta | 99.3% | 26.1% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 67.4% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,381
...
| Asertividad viva | 40.3% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,381 | — | — aciertos |
