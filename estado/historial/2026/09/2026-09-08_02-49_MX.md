...
**Generado:** 2026-09-08 08:49 UTC (02:49 UTC-6)
...
| Hora de la medición | 2026-09-08 08:48 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.4, muro 1/5 y firma máxima 96%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.4 | 8.4 | 9.9 | 27.5 | P70 |
| Muro de los 5 | 1 | 1.7 | 2.5 | 3 | P13 |
| Silent Trigger | inactivo | 69% ciclos | 83% ciclos | — | — |
| Asertividad viva | 38% | — | — | — | — |
...
|---|---|---|---|---|
| **96%** `▓▓▓▓▓` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
...
| alfa2 | _en vivo · 6 ciclos · 1064 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 37.7% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.8% | — | 0.31 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 60.5% | — | 0.31 |
| beta2 | 98.8% | 21.2% | — | 0.30 |
| delta | 98.9% | 24.9% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 59.1% | — | 0.31 |
| padre | 99.0% | 42.2% | — | 0.31 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,763
...
| Asertividad viva | 37.7% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,763 | — | — aciertos |
