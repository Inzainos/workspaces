...
**Generado:** 2026-09-01 16:25 UTC (10:25 UTC-6)
...
| Hora de la medición | 2026-09-01 16:25 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.3, muro 2/5 y firma máxima 91%.
...
| Muro de los 5 | 2 | 1.6 | 2.3 | 3 | P49 |
| Silent Trigger | activo | 63% ciclos | 79% ciclos | — | — |
| Asertividad viva | 41% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 5621 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 41% |
...
| **87%** `▓▓▓▓░` | SISMO_M5 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 228 | ~8 días |
...
| alfa2 | _en vivo · 10 ciclos · 1783 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 40.5% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.8% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 63.8% | — | 0.30 |
| beta2 | 99.1% | 22.4% | — | 0.30 |
| delta | 99.3% | 26.3% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 68.5% | — | 0.30 |
| padre | 99.1% | 43.7% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,341
...
| Asertividad viva | 40.5% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,341 | — | — aciertos |
