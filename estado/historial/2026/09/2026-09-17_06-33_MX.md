...
**Generado:** 2026-09-17 12:33 UTC (06:33 UTC-6)
...
| Hora de la medición | 2026-09-17 12:32 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.8, muro 1/5 y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.8 | 16.4 | 14.1 | 61.2 | P67 |
| Muro de los 5 | 1 | 1.5 | 1.8 | 3 | P38 |
| Silent Trigger | inactivo | 51% ciclos | 56% ciclos | — | — |
| Asertividad viva | 36% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 6453 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 36% |
| **Ganancia** (sistema ÷ tasa base) | 0.37× |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 49 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 119 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 21 | ~8 días |
| **83%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 7 | ~9 días |
...
| alfa2 | _en vivo · 14 ciclos · 2086 pases observados_ | — | 0.30 `▓░░░░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 99.4% |
| **Viva** (operación real, auditada) | 35.5% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.6% | 34.1% | — | 0.30 |
| alfa2 | 0.7% | 0.7% | — | 0.30 |
| beta1 | 99.5% | 57.6% | — | 0.30 |
| beta2 | 98.5% | 20.3% | — | 0.30 |
| delta | 98.4% | 23.8% | — | 0.30 |
| jupiter | 2.1% | 2.1% | — | 0.30 |
| omega | 99.8% | 52.5% | — | 0.30 |
| padre | 98.9% | 40.9% | — | 0.30 |
...
- ACIERTO — avisó y el evento ocurrió: 2,291
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,161
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 592
...
| Asertividad viva | 35.5% | — | — |
| Aciertos / Fallos (vivos) | 2,291 / 4,161 | — | — aciertos |
| Pendientes de auditoría | 592 | — | — |
...
| **Fallos** | 34203 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 25.9% `▓▓▓░░░░░░░░░` |
| **Predicciones auditadas** | 46138 |
| **Pendientes (ventana abierta)** | 592 |
...
|-----|----------|------|-----------|------------------------|
| omega | 3460/7640 | 45% `▓▓▓▓░░░░` | 0.46 | 4.3 |
| beta1 | 2687/7640 | 35% `▓▓▓░░░░░` | 0.36 | 4.3 |
| padre | 2055/7658 | 27% `▓▓░░░░░░` | 0.27 | 4.4 |
| alfa1 | 1842/7640 | 24% `▓▓░░░░░░` | 0.25 | 4.3 |
| delta | 1030/7640 | 13% `▓░░░░░░░` | 0.14 | 4.3 |
| beta2 | 857/7640 | 11% `▓░░░░░░░` | 0.11 | 4.3 |
| jupiter | 3/140 | 2% `░░░░░░░░` | 0.21 | 233.8 |
| alfa2 | 1/140 | 1% `░░░░░░░░` | 0.30 | 233.8 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### PADRE — alert — (—)

- **Predicción:** 2026-09-17 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-17 08:32:23
...
- **Predicción:** 2026-09-17 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-17 08:32:22
...
- **Predicción:** 2026-09-17 08:32 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-17 08:32:21
...
_... y 11925 aciertos más en los últimos 30 días_
...
*Ciclos totales: 218 · Sentinel Omega · Fractal Core Research*
