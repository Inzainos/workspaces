...
**Generado:** 2026-09-03 19:15 UTC (13:15 UTC-6)
...
| Hora de la medición | 2026-09-03 19:15 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.4, muro 2/5 y firma máxima 96%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.4 | 9.3 | 10.3 | 27.5 | P28 |
| Muro de los 5 | 2 | 1.4 | 2.4 | 3 | P37 |
| Silent Trigger | activo | 43% ciclos | 77% ciclos | — | — |
| Asertividad viva | 40% | — | — | — | — |
...
|---|---|---|---|---|
| **96%** `▓▓▓▓▓` | SISMO_M7 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 5 | ~12 días |
| **93%** `▓▓▓▓▓` | SISMO_M5 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 279 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 35 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 40 | ~9 días |
...
| alfa2 | _en vivo · 7 ciclos · 1231 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 39.8% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.3% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 62.9% | — | 0.30 |
| beta2 | 99.1% | 22.1% | — | 0.30 |
| delta | 99.2% | 25.9% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 65.9% | — | 0.30 |
| padre | 99.1% | 43.3% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,445
...
| Asertividad viva | 39.8% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,445 | — | — aciertos |
