...
**Generado:** 2026-09-13 22:19 UTC (16:19 UTC-6)
...
| Hora de la medición | 2026-09-13 22:19 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.5, muro 2/5 y firma máxima 88%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.5 | 9.4 | 9.9 | 21.3 | P36 |
| Muro de los 5 | 2 | 1.4 | 2.2 | 3 | P55 |
...
|---|---|---|---|---|
| **88%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 174 | ~8 días |
...
| **83%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 37 | ~8 días |
...
| alfa2 | _en vivo · 12 ciclos · 1992 pases observados_ | — | 0.30 `▓░░░░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 480
...
| **Pendientes (ventana abierta)** | 480 |
