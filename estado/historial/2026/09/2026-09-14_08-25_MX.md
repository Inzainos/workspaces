...
**Generado:** 2026-09-14 14:25 UTC (08:25 UTC-6)
...
| Hora de la medición | 2026-09-14 14:25 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.3, muro 1/5 y firma máxima 89%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.3 | 9.2 | 9.6 | 21.3 | P15 |
| Muro de los 5 | 1 | 1.4 | 2.1 | 3 | P32 |
| Silent Trigger | inactivo | 42% ciclos | 62% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
|---|---|---|---|---|
| **89%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 82 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 54 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 5 | ~9 días |
| **84%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 11 | ~9 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 130 | ~8 días |
...
| alfa2 | _en vivo · 15 ciclos · 2419 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 36.6% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.6% | 34.9% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 59.0% | — | 0.30 |
| beta2 | 98.6% | 20.7% | — | 0.30 |
| delta | 98.6% | 24.3% | — | 0.30 |
| jupiter | 1.8% | 1.8% | — | 0.30 |
| omega | 99.8% | 55.7% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,953
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 528
...
| Asertividad viva | 36.6% | — | — |
| Aciertos / Fallos (vivos) | 2,283 / 3,953 | — | — aciertos |
| Pendientes de auditoría | 528 | — | — |
...
| **Fallos** | 32014 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 30.3% `▓▓▓▓░░░░░░░░` |
| **Predicciones auditadas** | 45957 |
| **Pendientes (ventana abierta)** | 528 |
...
|-----|----------|------|-----------|------------------------|
| omega | 3880/7613 | 51% `▓▓▓▓░░░░` | 0.52 | 3.5 |
| beta1 | 3065/7613 | 40% `▓▓▓░░░░░` | 0.41 | 3.5 |
| padre | 2419/7666 | 32% `▓▓▓░░░░░` | 0.32 | 3.9 |
| alfa1 | 2136/7613 | 28% `▓▓░░░░░░` | 0.28 | 3.5 |
| delta | 1250/7613 | 16% `▓░░░░░░░` | 0.17 | 3.5 |
| beta2 | 1191/7613 | 16% `▓░░░░░░░` | 0.16 | 3.5 |
| jupiter | 2/113 | 2% `░░░░░░░░` | 0.21 | 233.4 |
| alfa2 | 0/113 | 0% `░░░░░░░░` | 0.30 | 233.4 |
...
_... y 13933 aciertos más en los últimos 30 días_
...
*Ciclos totales: 197 · Sentinel Omega · Fractal Core Research*
