...
**Generado:** 2026-09-14 18:25 UTC (12:25 UTC-6)
...
| Hora de la medición | 2026-09-14 18:25 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.0, muro 1/5 y firma máxima 96%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.0 | 9.1 | 9.6 | 21.3 | P12 |
| Muro de los 5 | 1 | 1.4 | 2.0 | 3 | P34 |
| Silent Trigger | inactivo | 41% ciclos | 60% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
|---|---|---|---|---|
| **96%** `▓▓▓▓▓` | SISMO_M5 | **Tabasco Delta** (18.0, -93.0) · nodo 49 | 225 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 22 | ~9 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 14 | ~9 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 130 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Ghost Baja-Sonora** (28.0, -113.0) · nodo 55 | 110 | ~8 días |
...
| alfa2 | _en vivo · 17 ciclos · 2735 pases observados_ | — | 0.30 `▓░░░░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,961
...
| Aciertos / Fallos (vivos) | 2,283 / 3,961 | — | — aciertos |
...
|-----|----------|------|-----------|------------------------|
| omega | 3880/7614 | 51% `▓▓▓▓░░░░` | 0.52 | 3.5 |
| beta1 | 3065/7614 | 40% `▓▓▓░░░░░` | 0.41 | 3.5 |
| padre | 2417/7665 | 32% `▓▓▓░░░░░` | 0.32 | 3.9 |
| alfa1 | 2136/7614 | 28% `▓▓░░░░░░` | 0.28 | 3.5 |
| delta | 1250/7614 | 16% `▓░░░░░░░` | 0.17 | 3.5 |
| beta2 | 1191/7614 | 16% `▓░░░░░░░` | 0.16 | 3.5 |
| jupiter | 2/114 | 2% `░░░░░░░░` | 0.21 | 233.3 |
| alfa2 | 0/114 | 0% `░░░░░░░░` | 0.30 | 233.3 |
...
_... y 13931 aciertos más en los últimos 30 días_
...
*Ciclos totales: 199 · Sentinel Omega · Fractal Core Research*
