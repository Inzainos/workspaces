...
**Generado:** 2026-09-03 14:20 UTC (08:20 UTC-6)
...
| Hora de la medición | 2026-09-03 14:19 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.5 | 9.3 | 10.4 | 27.5 | P28 |
| Muro de los 5 | 2 | 1.4 | 2.4 | 3 | P36 |
| Silent Trigger | activo | 41% ciclos | 76% ciclos | — | — |
| Asertividad viva | 40% | — | — | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Rivera Plate Deep** (20.5, -107.5) · nodo 125 | 248 | ~8 días |
...
| alfa2 | _en vivo · 6 ciclos · 1053 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 40.0% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.4% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 63.1% | — | 0.30 |
| beta2 | 99.1% | 22.2% | — | 0.30 |
| delta | 99.2% | 26.0% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 66.5% | — | 0.30 |
| padre | 99.1% | 43.4% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,421
...
| Asertividad viva | 40.0% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,421 | — | — aciertos |
