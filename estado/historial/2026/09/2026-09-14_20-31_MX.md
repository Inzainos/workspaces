...
**Generado:** 2026-09-15 02:31 UTC (20:31 UTC-6)
...
| Hora de la medición | 2026-09-15 02:31 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.9, muro 1/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.9 | 9.1 | 9.6 | 21.3 | P66 |
| Muro de los 5 | 1 | 1.4 | 1.9 | 3 | P39 |
| Silent Trigger | inactivo | 40% ciclos | 56% ciclos | — | — |
| Asertividad viva | 36% | — | — | — | — |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 29 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 6 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 119 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 6 | ~8 días |
...
| alfa2 | _en vivo · 21 ciclos · 3345 pases observados_ | — | 0.30 `▓░░░░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,985
...
| Aciertos / Fallos (vivos) | 2,283 / 3,985 | — | — aciertos |
...
|-----|----------|------|-----------|------------------------|
| omega | 3880/7617 | 51% `▓▓▓▓░░░░` | 0.52 | 3.6 |
| beta1 | 3065/7617 | 40% `▓▓▓░░░░░` | 0.41 | 3.6 |
| padre | 2413/7664 | 31% `▓▓▓░░░░░` | 0.32 | 4.0 |
| alfa1 | 2136/7617 | 28% `▓▓░░░░░░` | 0.28 | 3.6 |
| delta | 1250/7617 | 16% `▓░░░░░░░` | 0.17 | 3.6 |
| beta2 | 1191/7617 | 16% `▓░░░░░░░` | 0.16 | 3.6 |
| jupiter | 2/117 | 2% `░░░░░░░░` | 0.21 | 232.9 |
| alfa2 | 0/117 | 0% `░░░░░░░░` | 0.30 | 232.9 |
...
_... y 13927 aciertos más en los últimos 30 días_
