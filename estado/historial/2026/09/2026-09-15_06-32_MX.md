...
**Generado:** 2026-09-15 12:32 UTC (06:32 UTC-6)
...
|---|---|---|
| Fantasma | 🔴 **34.9** `▓▓▓▓▓▓░░░░` | condiciones muy cargadas |
...
| Hora de la medición | 2026-09-15 12:32 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 34.9, muro 2/5 y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 34.9 | 10.2 | 10.1 | 34.9 | P100 |
| Muro de los 5 | 2 | 1.5 | 2.0 | 3 | P69 |
| Silent Trigger | activo | 45% ciclos | 58% ciclos | — | — |
| Asertividad viva | 36% | — | — | — | — |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M7 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 5 | ~12 días |
...
| **87%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 24 | ~9 días |
...
| alfa2 | _en vivo · 14 ciclos · 2135 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 36.1% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.6% | 34.6% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.5% | 58.5% | — | 0.30 |
| beta2 | 98.6% | 20.5% | — | 0.30 |
| delta | 98.5% | 24.0% | — | 0.30 |
| jupiter | 1.6% | 1.6% | — | 0.30 |
| omega | 99.8% | 54.4% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,033
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 536
...
| Asertividad viva | 36.1% | — | — |
| Aciertos / Fallos (vivos) | 2,283 / 4,033 | — | — aciertos |
| Pendientes de auditoría | 536 | — | — |
...
| **Predicciones auditadas** | 46026 |
| **Pendientes (ventana abierta)** | 536 |
...
|-----|----------|------|-----------|------------------------|
| omega | 3740/7623 | 49% `▓▓▓▓░░░░` | 0.50 | 3.8 |
| beta1 | 2938/7623 | 39% `▓▓▓░░░░░` | 0.39 | 3.8 |
| padre | 2291/7665 | 30% `▓▓░░░░░░` | 0.30 | 4.1 |
| alfa1 | 2038/7623 | 27% `▓▓░░░░░░` | 0.27 | 3.8 |
| delta | 1175/7623 | 15% `▓░░░░░░░` | 0.16 | 3.8 |
| beta2 | 1078/7623 | 14% `▓░░░░░░░` | 0.14 | 3.8 |
| jupiter | 2/123 | 2% `░░░░░░░░` | 0.21 | 233.4 |
| alfa2 | 0/123 | 0% `░░░░░░░░` | 0.30 | 233.4 |
...
_... y 13252 aciertos más en los últimos 30 días_
...
*Ciclos totales: 203 · Sentinel Omega · Fractal Core Research*
