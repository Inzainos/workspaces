...
**Generado:** 2026-09-01 11:28 UTC (05:28 UTC-6)
...
| Hora de la medición | 2026-09-01 11:28 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.7, muro 1/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.7 | 8.8 | 10.1 | 27.5 | P38 |
| Muro de los 5 | 1 | 1.6 | 2.3 | 3 | P18 |
| Silent Trigger | inactivo | 64% ciclos | 79% ciclos | — | — |
| Asertividad viva | 41% | — | — | — | — |
...
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 32 | ~8 días |
...
| alfa2 | _en vivo · 9 ciclos · 1611 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 40.6% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 37.9% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 63.9% | — | 0.30 |
| beta2 | 99.2% | 22.5% | — | 0.30 |
| delta | 99.3% | 26.3% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 68.7% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,333
...
| Asertividad viva | 40.6% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,333 | — | — aciertos |
