...
**Generado:** 2026-09-09 11:06 UTC (05:06 UTC-6)
...
| Hora de la medición | 2026-09-09 11:06 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.8, muro 1/5 y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.8 | 9.1 | 9.8 | 21.3 | P86 |
| Muro de los 5 | 1 | 1.7 | 2.4 | 3 | P14 |
| Silent Trigger | inactivo | 68% ciclos | 82% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
|---|---|---|---|---|
| **90%** `▓▓▓▓▓` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 106 | ~8 días |
...
| alfa2 | _en vivo · 11 ciclos · 1940 pases observados_ | — | 0.30 `▓░░░░░` |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.6% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 60.1% | — | 0.30 |
| beta2 | 98.8% | 21.1% | — | 0.30 |
| delta | 98.8% | 24.7% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 58.2% | — | 0.30 |
| padre | 99.0% | 42.1% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,811
...
| Aciertos / Fallos (vivos) | 2,281 / 3,811 | — | — aciertos |
