...
**Generado:** 2026-09-25 06:37 UTC (00:37 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **14.7** `▓▓░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-09-25 06:37 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 14.7, muro 1/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 14.7 | 8.9 | 12.8 | 61.2 | P83 |
| Muro de los 5 | 1 | 1.7 | 1.7 | 2 | P35 |
| Silent Trigger | inactivo | 73% ciclos | 65% ciclos | — | — |
| Asertividad viva | 34% | — | — | — | — |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Rivera Plate Deep** (20.5, -107.5) · nodo 125 | 248 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 11 | ~9 días |
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Ghost East Pacific Rise N** (10.0, -104.0) · nodo 91 | 12 | ~9 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 145 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **Ghost Perú-Chile** (-18.0, -72.0) · nodo 60 | 22 | ~9 días |
...
| alfa2 | _en vivo · 23 ciclos · 3250 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 33.8% |
| **Últimos 7 días** (viva) | — |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 4,518
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 960
...
| Asertividad viva | 33.8% | — | — |
| Aciertos / Fallos (vivos) | 2,310 / 4,518 | — | — aciertos |
| Pendientes de auditoría | 960 | — | — |
...
| **Predicciones auditadas** | 45904 |
| **Pendientes (ventana abierta)** | 960 |
...
|-----|----------|------|-----------|------------------------|
| omega | 2897/7613 | 38% `▓▓▓░░░░░` | 0.39 | 3.4 |
| beta1 | 2200/7613 | 29% `▓▓░░░░░░` | 0.29 | 3.4 |
| padre | 1609/7613 | 21% `▓▓░░░░░░` | 0.21 | 3.4 |
| alfa1 | 1449/7613 | 19% `▓▓░░░░░░` | 0.19 | 3.4 |
| delta | 765/7613 | 10% `▓░░░░░░░` | 0.10 | 3.4 |
| beta2 | 432/7613 | 6% `░░░░░░░░` | 0.06 | 3.4 |
| jupiter | 8/113 | 7% `▓░░░░░░░` | 0.21 | 226.6 |
| alfa2 | 3/113 | 3% `░░░░░░░░` | 0.30 | 226.6 |
...
*Ciclos totales: 267 · Sentinel Omega · Fractal Core Research*
