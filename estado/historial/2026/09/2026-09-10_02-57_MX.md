...
**Generado:** 2026-09-10 08:57 UTC (02:57 UTC-6)
...
| Hora de la medición | 2026-09-10 08:56 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.6, muro 1/5 y firma máxima 88%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.6 | 9.3 | 9.8 | 21.3 | P77 |
| Muro de los 5 | 1 | 1.6 | 2.4 | 3 | P16 |
| Silent Trigger | inactivo | 58% ciclos | 79% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 6 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 37 | ~8 días |
...
| alfa2 | _en vivo · 6 ciclos · 1020 pases observados_ | — | 0.30 `▓░░░░░` |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.4% | — | 0.31 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 59.8% | — | 0.31 |
| beta2 | 98.7% | 21.0% | — | 0.30 |
| delta | 98.8% | 24.6% | — | 0.30 |
| jupiter | 1.0% | 1.0% | — | 0.30 |
| omega | 99.9% | 57.5% | — | 0.31 |
| padre | 99.0% | 41.9% | — | 0.31 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,850
...
| Aciertos / Fallos (vivos) | 2,282 / 3,850 | — | — aciertos |
