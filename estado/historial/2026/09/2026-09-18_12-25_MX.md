...
**Generado:** 2026-09-18 18:25 UTC (12:25 UTC-6)
...
| Hora de la medición | 2026-09-18 18:25 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.4, muro 2/5 y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.4 | 15.6 | 13.6 | 61.2 | P41 |
| Muro de los 5 | 2 | 1.6 | 1.8 | 3 | P85 |
| Silent Trigger | activo | 57% ciclos | 61% ciclos | — | — |
| Asertividad viva | 35% | — | — | — | — |
...
|---|---|---|---|---|
| **90%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 21 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 49 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 30 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 8 | ~9 días |
...
| alfa2 | _en vivo · 17 ciclos · 2655 pases observados_ | — | 0.30 `▓░░░░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 664
...
| **Predicciones auditadas** | 46171 |
| **Pendientes (ventana abierta)** | 664 |
...
*Ciclos totales: 228 · Sentinel Omega · Fractal Core Research*
