...
**Generado:** 2026-09-11 19:06 UTC (13:06 UTC-6)
...
| Hora de la medición | 2026-09-11 19:06 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.0, muro 2/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.0 | 9.6 | 9.9 | 21.3 | P42 |
| Muro de los 5 | 2 | 1.4 | 2.3 | 3 | P48 |
| Silent Trigger | activo | 45% ciclos | 73% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 193 | ~8 días |
...
| alfa2 | _en vivo · 7 ciclos · 1174 pases observados_ | — | 0.30 `▓░░░░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,906
...
| Aciertos / Fallos (vivos) | 2,282 / 3,906 | — | — aciertos |
...
|-----|----------|------|-----------|------------------------|
| omega | 4300/7607 | 57% `▓▓▓▓▓░░░` | 0.57 | 3.3 |
| beta1 | 3446/7607 | 45% `▓▓▓▓░░░░` | 0.46 | 3.3 |
| padre | 2786/7692 | 36% `▓▓▓░░░░░` | 0.36 | 4.1 |
| alfa1 | 2430/7607 | 32% `▓▓▓░░░░░` | 0.32 | 3.3 |
| beta2 | 1530/7607 | 20% `▓▓░░░░░░` | 0.20 | 3.3 |
| delta | 1475/7607 | 19% `▓▓░░░░░░` | 0.20 | 3.3 |
| jupiter | 1/107 | 1% `░░░░░░░░` | 0.20 | 234.3 |
| alfa2 | 0/107 | 0% `░░░░░░░░` | 0.30 | 234.3 |
