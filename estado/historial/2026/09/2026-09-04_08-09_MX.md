...
**Generado:** 2026-09-04 14:09 UTC (08:09 UTC-6)
...
| Hora de la medición | 2026-09-04 14:08 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.8, muro 2/5 y firma máxima 97%.
...
| Silent Trigger | activo | 47% ciclos | 77% ciclos | — | — |
| Asertividad viva | 39% | — | — | — | — |
...
|---|---|---|---|---|
| **97%** `▓▓▓▓▓` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 394 | ~8 días |
...
| alfa2 | _en vivo · 6 ciclos · 1065 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 38.9% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.8% | 36.6% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 61.9% | — | 0.30 |
| beta2 | 99.0% | 21.7% | — | 0.30 |
| delta | 99.1% | 25.5% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 62.8% | — | 0.30 |
| padre | 99.1% | 42.9% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,579
...
| Asertividad viva | 38.9% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,579 | — | — aciertos |
