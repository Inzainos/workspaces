...
**Generado:** 2026-09-12 08:40 UTC (02:40 UTC-6)
...
| Hora de la medición | 2026-09-12 08:38 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.3, muro 1/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.3 | 9.7 | 9.9 | 21.3 | P32 |
| Muro de los 5 | 1 | 1.4 | 2.3 | 3 | P25 |
| Silent Trigger | inactivo | 41% ciclos | 69% ciclos | — | — |
| Asertividad viva | 37% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 6213 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 37% |
| **Ganancia** (sistema ÷ tasa base) | 0.38× |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M6 | **Ghost Guerrero Deep** (17.0, -100.0) · nodo 87 | 6 | ~9 días |
...
| **86%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 6 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 29 | ~8 días |
...
| alfa2 | _en vivo · 5 ciclos · 843 pases observados_ | — | 0.30 `▓░░░░░` |
...
| Métrica | Valor |
|---|---|
| **Histórica** (examen sobre 32 años) | 99.5% |
| **Viva** (operación real, auditada) | 36.7% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 35.0% | — | 0.31 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.6% | 59.2% | — | 0.31 |
| beta2 | 98.7% | 20.8% | — | 0.30 |
| delta | 98.7% | 24.4% | — | 0.30 |
| jupiter | 0.9% | 0.9% | — | 0.30 |
| omega | 99.8% | 56.1% | — | 0.31 |
| padre | 98.9% | 41.7% | — | 0.31 |
...
- ACIERTO — avisó y el evento ocurrió: 2,282
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,930
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 392
...
| Asertividad viva | 36.7% | — | — |
| Aciertos / Fallos (vivos) | 2,282 / 3,930 | — | — aciertos |
| Pendientes de auditoría | 392 | — | — |
...
| **Fallos** | 31424 |
| **Falsos positivos** | 0 |
| **Tasa de acierto** | 34.2% `▓▓▓▓░░░░░░░░` |
| **Predicciones auditadas** | 47759 |
| **Pendientes (ventana abierta)** | 392 |
...
|-----|----------|------|-----------|------------------------|
| omega | 4416/7910 | 56% `▓▓▓▓░░░░` | 0.56 | 3.3 |
| beta1 | 3533/7910 | 45% `▓▓▓▓░░░░` | 0.45 | 3.3 |
| padre | 2847/7989 | 36% `▓▓▓░░░░░` | 0.36 | 3.9 |
| alfa1 | 2488/7910 | 31% `▓▓▓░░░░░` | 0.32 | 3.3 |
| beta2 | 1546/7910 | 20% `▓▓░░░░░░` | 0.20 | 3.3 |
| delta | 1504/7910 | 19% `▓▓░░░░░░` | 0.19 | 3.3 |
| jupiter | 1/110 | 1% `░░░░░░░░` | 0.20 | 233.8 |
| alfa2 | 0/110 | 0% `░░░░░░░░` | 0.30 | 233.8 |

### 🎯 Eventos Predichos Correctamente (más recientes primero)

#### PADRE — alert — (—)

- **Predicción:** 2026-09-12 08:39 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-12 08:39:20
...
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-12 08:39:20
- **Verdad registrada:** 2025-01-05 13:08|nodo99|M4.3
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Predicción:** 2026-09-12 08:39 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-12 08:39:19
...
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-12 08:39:19
- **Verdad registrada:** 2025-01-09 09:51|nodo81|M4.5
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
- **Predicción:** 2026-09-12 08:39 UTC
- **Ventana declarada:** 0h
- **Resuelta por el Juez:** 2026-09-12 08:39:18
- **Verdad registrada:** 2025-01-13 14:17|nodo21|M4.3
- **Confianza:** 100.0% `▓▓▓▓▓▓▓▓▓▓`
- **Fase:** trasfondo
...
_... y 16325 aciertos más en los últimos 30 días_
...
*Ciclos totales: 189 · Sentinel Omega · Fractal Core Research*
