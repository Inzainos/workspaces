...
**Generado:** 2026-09-06 04:01 UTC (22:01 UTC-6)
...
| Hora de la medición | 2026-09-06 04:01 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 7.8, muro 2/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 7.8 | 8.4 | 10.2 | 27.5 | P18 |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 130 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 14 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 47 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Ghost Baja-Sonora** (28.0, -113.0) · nodo 55 | 110 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M7 | **San Andreas S** (33.9, -116.5) · nodo 18 | 6 | ~12 días |
...
| alfa2 | _en vivo · 11 ciclos · 1962 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 38.0% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.7% | 36.0% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.7% | 60.8% | — | 0.30 |
| beta2 | 98.9% | 21.3% | — | 0.30 |
| delta | 99.0% | 25.0% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 59.9% | — | 0.30 |
| padre | 99.0% | 42.4% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,723
...
| Asertividad viva | 38.0% | — | — |
| Aciertos / Fallos (vivos) | 2,281 / 3,723 | — | — aciertos |
