...
**Generado:** 2026-08-21 06:57 UTC (00:57 UTC-6)
...
| Hora de la medición | 2026-08-21 06:57 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.6, muro 3/5 (breach) y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.6 | 10.2 | 10.7 | 27.5 | P52 |
| Muro de los 5 | 3 | 2.4 | 2.5 | 3 | P100 |
| Silent Trigger | activo | 42% ciclos | 56% ciclos | — | — |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 58 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M7 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 5 | ~12 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 88 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.82 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.86 `▓▓▓░░░` |
| beta2 | 467 | 21,720 | 0.31 `▓░░░░░` |
| delta | 380 | 15,727 | 0.31 `▓░░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.30 `▓░░░░░` |
| alfa2 | _en vivo · 458 ciclos · 85920 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| Aciertos / Fallos (vivos) | 2,271 / 3,041 | — | — aciertos |
| Pendientes de auditoría | 140 | — | — |
| Pesos de bots | alfa1 0.82, beta1 0.86, beta2 0.31, delta 0.31, omega 1.00, padre 0.30 | — | primera bitácora |
