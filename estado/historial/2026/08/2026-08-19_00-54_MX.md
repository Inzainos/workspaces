...
**Generado:** 2026-08-19 06:54 UTC (00:54 UTC-6)
...
| Hora de la medición | 2026-08-19 06:54 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 18.3, muro 2/5 y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 18.3 | 9.5 | 10.3 | 27.5 | P95 |
...
| **81%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Tlaxcala Acuífero** (19.3, -98.2) · nodo 118 | 31 | ~8 días |
| **80%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 14 | ~8 días |
...
| alfa2 | _en vivo · 435 ciclos · 81595 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,263
...
| Aciertos / Fallos (vivos) | 2,263 / 3,024 | — | — aciertos |
