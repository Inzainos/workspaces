...
**Generado:** 2026-08-12 22:50 UTC (16:50 UTC-6)
...
| Hora de la medición | 2026-08-12 22:50 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.0, muro 3/5 (breach) y firma máxima 88%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.0 | 9.6 | 9.4 | 27.5 | P66 |
| Muro de los 5 | 3 | 2.0 | 2.3 | 3 | P100 |
| Silent Trigger | activo | 61% ciclos | 76% ciclos | — | — |
| Asertividad viva | 43% | 64% | — | — | — |
...
|---|---|---|---|---|
| **88%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 98 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 33 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 19 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 62 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.90 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 0.94 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.47 `▓▓░░░░` |
| delta | 380 | 15,727 | 0.47 `▓▓░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.43 `▓▓░░░░` |
| alfa2 | _en vivo · 361 ciclos · 67503 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 64.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.90 |
| beta1 | 99.9% | 66.3% | — | 0.94 |
| beta2 | 99.5% | 23.3% | — | 0.47 |
| delta | 99.8% | 27.3% | — | 0.47 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 44.9% | 64.1% | 0.43 |
...
- ACIERTO — avisó y el evento ocurrió: 2,228
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,987
...
| Aciertos / Fallos (vivos) | 2,228 / 2,987 | — | — aciertos |
| Pendientes de auditoría | 35 | — | — |
| Pesos de bots | alfa1 0.90, beta1 0.94, beta2 0.47, delta 0.47, omega 1.00, padre 0.43 | — | primera bitácora |
