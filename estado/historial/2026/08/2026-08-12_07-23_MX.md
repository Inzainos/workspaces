...
**Generado:** 2026-08-12 13:23 UTC (07:23 UTC-6)
...
| Hora de la medición | 2026-08-12 13:23 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 8.7, muro 3/5 (breach) y firma máxima 88%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.7 | 9.6 | 9.5 | 27.5 | P53 |
| Muro de los 5 | 3 | 2.0 | 2.3 | 3 | P100 |
| Silent Trigger | activo | 63% ciclos | 77% ciclos | — | — |
| Asertividad viva | 43% | 59% | — | — | — |
...
|---|---|---|---|---|
| **88%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 14 | ~8 días |
...
| alfa2 | _en vivo · 356 ciclos · 66573 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,225
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,986
...
| Aciertos / Fallos (vivos) | 2,225 / 2,986 | — | — aciertos |
