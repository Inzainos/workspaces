...
**Generado:** 2026-08-23 12:52 UTC (06:52 UTC-6)
...
| Hora de la medición | 2026-08-23 12:52 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.2, muro 2/5 y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.2 | 10.2 | 10.6 | 27.5 | P32 |
| Muro de los 5 | 2 | 2.3 | 2.5 | 3 | P45 |
| Silent Trigger | activo | 49% ciclos | 66% ciclos | — | — |
| Asertividad viva | 43% | 29% | — | — | — |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 66 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M7 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 5 | ~12 días |
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 35 | ~9 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 38 | ~9 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.74 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.77 `▓▓▓░░░` |
| beta2 | 467 | 21,720 | 0.30 `▓░░░░░` |
| delta | 380 | 15,727 | 0.30 `▓░░░░░` |
| omega | 360 | 179,235 | 0.92 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.31 `▓░░░░░` |
| alfa2 | _en vivo · 14 ciclos · 2618 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 29.3% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 99.9% | 39.3% | — | 0.74 |
| beta1 | 99.9% | 66.3% | — | 0.77 |
| beta2 | 99.4% | 23.3% | — | 0.30 |
| delta | 99.7% | 27.3% | — | 0.30 |
| omega | 99.9% | 76.7% | — | 0.92 |
| padre | 99.2% | 44.8% | 29.3% | 0.31 |
...
- ACIERTO — avisó y el evento ocurrió: 2,279
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,053
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 336
...
| Aciertos / Fallos (vivos) | 2,279 / 3,053 | — | — aciertos |
| Pendientes de auditoría | 336 | — | — |
| Pesos de bots | alfa1 0.74, beta1 0.77, beta2 0.30, delta 0.30, omega 0.92, padre 0.31 | — | primera bitácora |
