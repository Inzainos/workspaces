...
**Generado:** 2026-08-07 19:06 UTC (13:06 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **5.6** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-07 19:06 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 5.6, muro 2/5 y firma máxima 99%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 5.6 | 7.7 | 9.2 | 25.4 | P1 |
| Muro de los 5 | 2 | 1.7 | 2.1 | 3 | P62 |
| Silent Trigger | activo | 72% ciclos | 79% ciclos | — | — |
...
|---|---|---|---|---|
| **99%** `▓▓▓▓▓` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 33 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 16 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 23 | ~8 días |
...
| alfa2 | _en vivo · 302 ciclos · 56793 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,963
...
| Aciertos / Fallos (vivos) | 2,202 / 2,963 | — | — aciertos |
