...
**Generado:** 2026-08-31 22:57 UTC (16:57 UTC-6)
...
| Hora de la medición | 2026-08-31 22:43 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.0, muro 2/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.0 | 8.9 | 10.1 | 27.5 | P42 |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 24 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 83 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 32 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 288 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Ghost Puebla-Veracruz** (19.0, -97.5) · nodo 72 | 228 | ~8 días |
...
| alfa2 | _en vivo · 7 ciclos · 1267 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 41.1% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 38.2% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 64.4% | — | 0.30 |
| beta2 | 99.2% | 22.7% | — | 0.30 |
| delta | 99.4% | 26.5% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 70.3% | — | 0.30 |
| padre | 99.1% | 44.0% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,269
...
| Asertividad viva | 41.1% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,269 | — | — aciertos |
