...
**Generado:** 2026-08-18 10:36 UTC (04:36 UTC-6)
...
| Hora de la medición | 2026-08-18 10:36 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.5, muro 2/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.5 | 8.8 | 9.8 | 27.5 | P44 |
| Muro de los 5 | 2 | 2.5 | 2.6 | 3 | P36 |
| Silent Trigger | inactivo | 51% ciclos | 65% ciclos | — | — |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M6 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 11 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 65 | ~8 días |
...
| alfa2 | _en vivo · 425 ciclos · 79691 pases observados_ | — | 1.00 `▓▓▓▓░░` |
