...
**Generado:** 2026-08-29 16:34 UTC (10:34 UTC-6)
...
| Hora de la medición | 2026-08-29 16:34 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 14.0, muro 1/5 y firma máxima 89%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 14.0 | 8.7 | 10.1 | 27.5 | P92 |
| Muro de los 5 | 1 | 1.8 | 2.3 | 3 | P11 |
| Silent Trigger | inactivo | 79% ciclos | 78% ciclos | — | — |
| Asertividad viva | 42% | — | — | — | — |
...
| alfa2 | _en vivo · 13 ciclos · 2478 pases observados_ | — | 0.63 `▓▓▓░░░` |
| jupiter | _en vivo · atención colectiva_ | — | 0.63 `▓▓▓░░░` |
...
| **Viva** (operación real, auditada) | 42.4% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 39.1% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.63 |
| beta1 | 99.8% | 65.9% | — | 0.30 |
| beta2 | 99.3% | 23.2% | — | 0.30 |
| delta | 99.6% | 27.2% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.63 |
| omega | 99.9% | 75.2% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,101
...
| Asertividad viva | 42.4% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,101 | — | — aciertos |
| Pendientes de auditoría | 664 | — | — |
| Pesos de bots | alfa1 0.30, alfa2 0.63, beta1 0.30, beta2 0.30, delta 0.30, jupiter 0.63, omega 0.30, padre 0.30 | — | primera bitácora |
