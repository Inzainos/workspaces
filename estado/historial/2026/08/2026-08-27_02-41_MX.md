...
**Generado:** 2026-08-27 08:41 UTC (02:41 UTC-6)
...
| Hora de la medición | 2026-08-27 08:40 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 5.9, muro 2/5 y firma máxima 95%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 5.9 | 9.3 | 10.1 | 27.5 | P1 |
| Muro de los 5 | 2 | 2.0 | 2.4 | 3 | P54 |
| Silent Trigger | activo | 76% ciclos | 79% ciclos | — | — |
| Asertividad viva | 43% | — | — | — | — |
...
|---|---|---|---|---|
| **95%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 32 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 11 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Ghost Ryukyu** (26.0, 128.0) · nodo 82 | 48 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 145 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 83 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.53 `▓▓░░░░` |
| beta1 | 494 | 49,001 | 0.55 `▓▓░░░░` |
| beta2 | 467 | 21,720 | 0.30 `▓░░░░░` |
| delta | 380 | 15,727 | 0.30 `▓░░░░░` |
| omega | 360 | 179,235 | 0.66 `▓▓▓░░░` |
| padre | 2,249 | 49,001 | 0.31 `▓░░░░░` |
| alfa2 | _en vivo · 7 ciclos · 1342 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 39.3% | — | 0.53 |
| beta1 | 99.9% | 66.3% | — | 0.55 |
| beta2 | 99.3% | 23.3% | — | 0.30 |
| delta | 99.6% | 27.3% | — | 0.30 |
| omega | 99.9% | 76.7% | — | 0.66 |
...
| Pesos de bots | alfa1 0.53, beta1 0.55, beta2 0.30, delta 0.30, omega 0.66, padre 0.31 | — | primera bitácora |
