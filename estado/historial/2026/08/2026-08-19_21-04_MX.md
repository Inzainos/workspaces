...
**Generado:** 2026-08-20 03:04 UTC (21:04 UTC-6)
...
| Hora de la medición | 2026-08-20 03:04 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.5, muro 2/5 y firma máxima 87%.
...
| Muro de los 5 | 2 | 2.5 | 2.5 | 3 | P44 |
| Silent Trigger | inactivo | 46% ciclos | 57% ciclos | — | — |
...
|---|---|---|---|---|
| **87%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 30 | ~9 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 394 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 47 | ~9 días |
| **83%** `▓▓▓▓░` | SISMO_M7 | **Kamchatka** (53.0, 159.0) · nodo 20 | 9 | ~12 días |
| **83%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 27 | ~8 días |
...
| alfa2 | _en vivo · 444 ciclos · 83310 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,027
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 43
...
| Aciertos / Fallos (vivos) | 2,270 / 3,027 | — | — aciertos |
| Pendientes de auditoría | 43 | — | — |
