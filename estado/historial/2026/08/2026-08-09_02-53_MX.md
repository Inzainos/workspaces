...
**Generado:** 2026-08-09 08:53 UTC (02:53 UTC-6)
...
| Hora de la medición | 2026-08-09 08:52 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 27.5, muro 1/5 y firma máxima 86%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 27.5 | 9.1 | 9.2 | 27.5 | P100 |
| Muro de los 5 | 1 | 1.5 | 2.1 | 3 | P27 |
| Silent Trigger | inactivo | 55% ciclos | 73% ciclos | — | — |
...
| **82%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 60 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 14 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 11 | ~9 días |
| **81%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 10 | ~9 días |
...
| alfa2 | _en vivo · 320 ciclos · 60012 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,203
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,976
...
| Aciertos / Fallos (vivos) | 2,203 / 2,976 | — | — aciertos |
