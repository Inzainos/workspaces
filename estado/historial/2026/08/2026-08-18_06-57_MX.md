...
**Generado:** 2026-08-18 12:57 UTC (06:57 UTC-6)
...
| Hora de la medición | 2026-08-18 12:57 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.3, muro 3/5 (breach) y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.3 | 8.8 | 9.8 | 27.5 | P69 |
| Muro de los 5 | 3 | 2.5 | 2.6 | 3 | P100 |
| Silent Trigger | activo | 51% ciclos | 65% ciclos | — | — |
...
| **90%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 11 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 82 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 155 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 15 | ~9 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.84 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.88 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.31 `▓░░░░░` |
| delta | 380 | 15,727 | 0.31 `▓░░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.31 `▓░░░░░` |
| alfa2 | _en vivo · 426 ciclos · 79881 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,255
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,024
...
| Aciertos / Fallos (vivos) | 2,255 / 3,024 | — | — aciertos |
| Pendientes de auditoría | 36 | — | — |
| Pesos de bots | alfa1 0.84, beta1 0.88, beta2 0.31, delta 0.31, omega 1.00, padre 0.31 | — | primera bitácora |
