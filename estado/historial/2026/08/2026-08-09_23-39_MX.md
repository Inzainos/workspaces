...
**Generado:** 2026-08-10 05:39 UTC (23:39 UTC-6)
...
| Hora de la medición | 2026-08-10 05:39 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.0, muro 1/5 y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.0 | 9.6 | 9.3 | 27.5 | P76 |
| Muro de los 5 | 1 | 1.6 | 2.1 | 3 | P28 |
| Silent Trigger | inactivo | 59% ciclos | 72% ciclos | — | — |
| Asertividad viva | 43% | 21% | — | — | — |
...
| **89%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 33 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 16 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.93 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 0.98 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.61 `▓▓░░░░` |
| delta | 380 | 15,727 | 0.61 `▓▓░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.52 `▓▓░░░░` |
| alfa2 | _en vivo · 329 ciclos · 61620 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 20.7% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.93 |
| beta1 | 99.9% | 66.3% | — | 0.98 |
| beta2 | 99.5% | 23.3% | — | 0.61 |
| delta | 99.9% | 27.3% | — | 0.61 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 44.3% | 20.7% | 0.52 |
...
- ACIERTO — avisó y el evento ocurrió: 2,206
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,977
...
| Aciertos / Fallos (vivos) | 2,206 / 2,977 | — | — aciertos |
| Pendientes de auditoría | 35 | — | — |
| Pesos de bots | alfa1 0.93, beta1 0.98, beta2 0.61, delta 0.61, omega 1.00, padre 0.52 | — | primera bitácora |
