...
**Generado:** 2026-08-31 17:31 UTC (11:31 UTC-6)
...
| Hora de la medición | 2026-08-31 17:31 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.5, muro 2/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.5 | 8.9 | 10.1 | 27.5 | P50 |
| Muro de los 5 | 2 | 1.6 | 2.4 | 3 | P47 |
| Silent Trigger | activo | 62% ciclos | 79% ciclos | — | — |
| Asertividad viva | 41% | — | — | — | — |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 288 | ~8 días |
| **90%** `▓▓▓▓▓` | SISMO_M5 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 279 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M6 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 38 | ~9 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 24 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Perú Minerales** (-13.0, -76.0) · nodo 121 | 245 | ~8 días |
...
| alfa2 | _en vivo · 6 ciclos · 1089 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 41.2% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 38.3% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 64.6% | — | 0.30 |
| beta2 | 99.2% | 22.7% | — | 0.30 |
| delta | 99.4% | 26.6% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 71.0% | — | 0.30 |
| padre | 99.1% | 44.1% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,245
...
| Asertividad viva | 41.2% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,245 | — | — aciertos |
