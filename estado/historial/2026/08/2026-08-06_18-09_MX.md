...
**Generado:** 2026-08-07 00:09 UTC (18:09 UTC-6)
...
| Hora de la medición | 2026-08-07 00:09 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 6.5, muro 2/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.5 | 7.9 | 9.5 | 25.4 | P16 |
| Muro de los 5 | 2 | 1.7 | 2.0 | 3 | P75 |
| Silent Trigger | activo | 72% ciclos | 63% ciclos | — | — |
...
| **84%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 16 | ~8 días |
...
| alfa2 | _en vivo · 293 ciclos · 55191 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,959
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 21
...
| Aciertos / Fallos (vivos) | 2,202 / 2,959 | — | — aciertos |
| Pendientes de auditoría | 21 | — | — |
