...
**Generado:** 2026-08-22 12:51 UTC (06:51 UTC-6)
...
| Hora de la medición | 2026-08-22 12:51 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.1, muro 2/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.1 | 10.0 | 10.7 | 27.5 | P47 |
| Muro de los 5 | 2 | 2.4 | 2.6 | 3 | P40 |
| Silent Trigger | activo | 46% ciclos | 64% ciclos | — | — |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 66 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 58 | ~8 días |
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
...
| alfa2 | _en vivo · 473 ciclos · 88337 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,047
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 246
...
| Aciertos / Fallos (vivos) | 2,279 / 3,047 | — | — aciertos |
| Pendientes de auditoría | 246 | — | — |
| Pesos de bots | alfa1 0.80, beta1 0.84, beta2 0.31, delta 0.31, omega 1.00, padre 0.32 | — | primera bitácora |
