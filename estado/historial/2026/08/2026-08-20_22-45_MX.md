...
**Generado:** 2026-08-21 04:45 UTC (22:45 UTC-6)
...
| Hora de la medición | 2026-08-21 04:45 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 10.8, muro 2/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.8 | 10.1 | 10.6 | 27.5 | P54 |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
...
| **85%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 66 | ~8 días |
...
| alfa2 | _en vivo · 457 ciclos · 85735 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,040
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 133
...
| Aciertos / Fallos (vivos) | 2,271 / 3,040 | — | — aciertos |
| Pendientes de auditoría | 133 | — | — |
