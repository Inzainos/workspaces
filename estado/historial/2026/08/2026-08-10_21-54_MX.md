...
**Generado:** 2026-08-11 03:54 UTC (21:54 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **10.5** `▓▓░░░░░░░░` | actividad moderada |
| Consenso de los 6 bots | NEUTRAL (20%) | evaluando |
| Muro de los 5 frentes | 3/5 activos | 🚨 **BREACH** — varios dominios alterados a la vez |
| Precursores detectados | 3 | ["SILENT_TRIGGER", "SEISMIC_CLUSTER", "TSUNAMI"] |
| Hora de la medición | 2026-08-11 03:54 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.5, muro 3/5 (breach) y firma máxima 84%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.5 | 9.5 | 9.6 | 27.5 | P66 |
| Muro de los 5 | 3 | 1.8 | 2.2 | 3 | P100 |
| Silent Trigger | activo | 70% ciclos | 76% ciclos | — | — |
| Asertividad viva | 43% | 28% | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 5195 |
| Ventanas con evento real (tasa base) | 98% |
| Asertividad del sistema | 43% |
| **Ganancia** (sistema ÷ tasa base) | 0.43× |
...
|---|---|---|---|---|
| **84%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 50 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Tlaxcala Acuífero** (19.3, -98.2) · nodo 118 | 31 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 14 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 103 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.92 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 0.97 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.56 `▓▓░░░░` |
| delta | 380 | 15,727 | 0.56 `▓▓░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.49 `▓▓░░░░` |
| alfa2 | _en vivo · 340 ciclos · 63617 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 42.6% |
| **Últimos 7 días** (viva) | 28.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.92 |
| beta1 | 99.9% | 66.3% | — | 0.97 |
| beta2 | 99.5% | 23.3% | — | 0.56 |
| delta | 99.8% | 27.3% | — | 0.56 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 44.3% | 28.1% | 0.49 |
...
- ACIERTO — avisó y el evento ocurrió: 2,211
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,983
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 35
...
| Asertividad viva | 42.6% | — | — |
| Aciertos / Fallos (vivos) | 2,211 / 2,983 | — | — aciertos |
| Pendientes de auditoría | 35 | — | — |
| Pesos de bots | alfa1 0.92, beta1 0.97, beta2 0.56, delta 0.56, omega 1.00, padre 0.49 | — | primera bitácora |
