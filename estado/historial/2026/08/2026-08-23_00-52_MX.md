...
**Generado:** 2026-08-23 06:52 UTC (00:52 UTC-6)
...
| Hora de la medición | 2026-08-23 06:52 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.4, muro 2/5 y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.4 | 10.2 | 10.7 | 27.5 | P36 |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 58 | ~8 días |
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **90%** `▓▓▓▓░` | SISMO_M7 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 5 | ~12 días |
...
| alfa2 | _en vivo · 482 ciclos · 90020 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- PENDIENTE — ventana de 72h aún abierta: 312
