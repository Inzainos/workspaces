...
**Generado:** 2026-09-01 04:35 UTC (22:35 UTC-6)
...
| Hora de la medición | 2026-09-01 04:35 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 8.7, muro 2/5 y firma máxima 93%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 8.7 | 8.9 | 10.1 | 27.5 | P38 |
| Muro de los 5 | 2 | 1.7 | 2.4 | 3 | P48 |
| Silent Trigger | activo | 67% ciclos | 79% ciclos | — | — |
| Asertividad viva | 41% | — | — | — | — |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M6 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 11 | ~9 días |
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 32 | ~8 días |
...
| alfa2 | _en vivo · 8 ciclos · 1439 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 41.0% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 38.1% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 64.3% | — | 0.30 |
| beta2 | 99.2% | 22.6% | — | 0.30 |
| delta | 99.4% | 26.5% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 69.9% | — | 0.30 |
| padre | 99.1% | 43.9% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,285
...
| Asertividad viva | 41.0% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,285 | — | — aciertos |
