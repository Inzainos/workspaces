...
**Generado:** 2026-08-10 15:06 UTC (09:06 UTC-6)
...
| Hora de la medición | 2026-08-10 15:06 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 11.6, muro 3/5 (breach) y firma máxima 84%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.6 | 9.5 | 9.5 | 27.5 | P78 |
| Muro de los 5 | 3 | 1.7 | 2.2 | 3 | P100 |
| Silent Trigger | activo | 62% ciclos | 74% ciclos | — | — |
| Asertividad viva | 43% | 26% | — | — | — |
...
| **82%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 30 | ~8 días |
...
| alfa2 | _en vivo · 334 ciclos · 62525 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,978
...
| Aciertos / Fallos (vivos) | 2,210 / 2,978 | — | — aciertos |
