...
**Generado:** 2026-08-20 22:34 UTC (16:34 UTC-6)
...
| Hora de la medición | 2026-08-20 22:34 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.1, muro 2/5 y firma máxima 88%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.1 | 10.1 | 10.6 | 27.5 | P60 |
| Muro de los 5 | 2 | 2.4 | 2.5 | 3 | P44 |
| Silent Trigger | inactivo | 41% ciclos | 57% ciclos | — | — |
| Asertividad viva | 43% | 51% | — | — | — |
...
| **82%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
...
| alfa2 | _en vivo · 454 ciclos · 85180 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,036
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 113
...
| Aciertos / Fallos (vivos) | 2,271 / 3,036 | — | — aciertos |
| Pendientes de auditoría | 113 | — | — |
