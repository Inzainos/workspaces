...
**Generado:** 2026-08-07 15:00 UTC (09:00 UTC-6)
...
|---|---|---|
| Fantasma | 🟡 **5.7** `▓░░░░░░░░░` | actividad moderada |
...
| Hora de la medición | 2026-08-07 15:00 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 5.7, muro 1/5 y firma máxima 89%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 5.7 | 7.8 | 9.4 | 25.4 | P3 |
| Muro de los 5 | 1 | 1.7 | 2.1 | 3 | P22 |
| Silent Trigger | inactivo | 72% ciclos | 78% ciclos | — | — |
...
| **87%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 30 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 18 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 20 | ~8 días |
...
| alfa2 | _en vivo · 300 ciclos · 56437 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,962
...
| Aciertos / Fallos (vivos) | 2,202 / 2,962 | — | — aciertos |
