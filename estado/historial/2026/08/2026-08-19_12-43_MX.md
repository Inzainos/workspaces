...
**Generado:** 2026-08-19 18:43 UTC (12:43 UTC-6)
...
| Hora de la medición | 2026-08-19 18:43 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 11.5, muro 3/5 (breach) y firma máxima 87%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.5 | 9.7 | 10.5 | 27.5 | P70 |
...
|---|---|---|---|---|
| **87%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 47 | ~9 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 394 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M7 | **Kamchatka** (53.0, 159.0) · nodo 20 | 9 | ~12 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 130 | ~8 días |
...
| alfa2 | _en vivo · 441 ciclos · 82741 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,268
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,025
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 37
...
| Aciertos / Fallos (vivos) | 2,268 / 3,025 | — | — aciertos |
| Pendientes de auditoría | 37 | — | — |
