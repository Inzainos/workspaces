...
**Generado:** 2026-08-14 17:00 UTC (11:00 UTC-6)
...
| Hora de la medición | 2026-08-14 17:00 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 12.7, muro 3/5 (breach) y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 12.7 | 10.1 | 9.5 | 27.5 | P90 |
| Muro de los 5 | 3 | 2.1 | 2.4 | 3 | P100 |
| Silent Trigger | activo | 51% ciclos | 70% ciclos | — | — |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M5 | **Guerrero Interior** (17.8, -99.5) · nodo 48 | 14 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Kamchatka** (53.0, 159.0) · nodo 20 | 45 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Ghost Dead Sea** (31.5, 35.5) · nodo 100 | 25 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.88 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 0.92 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.40 `▓▓░░░░` |
| delta | 380 | 15,727 | 0.40 `▓▓░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.37 `▓░░░░░` |
| alfa2 | _en vivo · 380 ciclos · 71075 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 64.4% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.88 |
| beta1 | 99.9% | 66.3% | — | 0.92 |
| beta2 | 99.5% | 23.3% | — | 0.40 |
| delta | 99.8% | 27.3% | — | 0.40 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 45.1% | 64.4% | 0.37 |
...
- ACIERTO — avisó y el evento ocurrió: 2,239
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,996
...
| Aciertos / Fallos (vivos) | 2,239 / 2,996 | — | — aciertos |
| Pendientes de auditoría | 34 | — | — |
| Pesos de bots | alfa1 0.88, beta1 0.92, beta2 0.40, delta 0.40, omega 1.00, padre 0.37 | — | primera bitácora |
