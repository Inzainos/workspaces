...
**Generado:** 2026-08-16 16:33 UTC (10:33 UTC-6)
...
| Hora de la medición | 2026-08-16 16:33 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.8, muro 3/5 (breach) y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.8 | 9.7 | 9.9 | 27.5 | P9 |
| Muro de los 5 | 3 | 2.5 | 2.6 | 3 | P100 |
| Silent Trigger | activo | 62% ciclos | 73% ciclos | — | — |
| Asertividad viva | 43% | 44% | — | — | — |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 50 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 13 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 10 | ~9 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **Guerrero Interior** (17.8, -99.5) · nodo 48 | 13 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 24 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.86 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.90 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.34 `▓░░░░░` |
| delta | 380 | 15,727 | 0.34 `▓░░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.33 `▓░░░░░` |
| alfa2 | _en vivo · 404 ciclos · 75659 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 44.4% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.86 |
| beta1 | 99.9% | 66.3% | — | 0.90 |
| beta2 | 99.5% | 23.3% | — | 0.34 |
| delta | 99.8% | 27.3% | — | 0.34 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 44.8% | 44.4% | 0.33 |
...
- ACIERTO — avisó y el evento ocurrió: 2,245
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,012
...
| Aciertos / Fallos (vivos) | 2,245 / 3,012 | — | — aciertos |
| Pendientes de auditoría | 36 | — | — |
| Pesos de bots | alfa1 0.86, beta1 0.90, beta2 0.34, delta 0.34, omega 1.00, padre 0.33 | — | primera bitácora |
