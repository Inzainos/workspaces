...
**Generado:** 2026-08-21 01:43 UTC (19:43 UTC-6)
...
| Hora de la medición | 2026-08-21 01:43 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 11.0, muro 2/5 y firma máxima 91%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.0 | 10.1 | 10.6 | 27.5 | P57 |
| Muro de los 5 | 2 | 2.4 | 2.5 | 3 | P44 |
| Silent Trigger | inactivo | 41% ciclos | 56% ciclos | — | — |
| Asertividad viva | 43% | 48% | — | — | — |
...
|---|---|---|---|---|
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 58 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M7 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 5 | ~12 días |
...
| alfa2 | _en vivo · 455 ciclos · 85365 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,038
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 119
...
| Aciertos / Fallos (vivos) | 2,271 / 3,038 | — | — aciertos |
| Pendientes de auditoría | 119 | — | — |
