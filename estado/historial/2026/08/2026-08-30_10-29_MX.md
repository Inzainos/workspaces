...
**Generado:** 2026-08-30 16:29 UTC (10:29 UTC-6)
...
| Hora de la medición | 2026-08-30 16:29 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.4 | 8.6 | 10.1 | 27.5 | P44 |
| Muro de los 5 | 1 | 1.7 | 2.3 | 3 | P14 |
| Silent Trigger | inactivo | 71% ciclos | 75% ciclos | — | — |
| Asertividad viva | 42% | — | — | — | — |
...
| Métrica | Valor |
|---|---:|
| Ventanas evaluadas (viva) | 5421 |
| Ventanas con evento real (tasa base) | 97% |
| Asertividad del sistema | 42% |
...
|---|---|---|---|---|
| **93%** `▓▓▓▓▓` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 288 | ~8 días |
| **91%** `▓▓▓▓▓` | SISMO_M6 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 38 | ~9 días |
| **91%** `▓▓▓▓▓` | SISMO_M5 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 279 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M7 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 5 | ~12 días |
| **88%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Perú Minerales** (-13.0, -76.0) · nodo 121 | 245 | ~8 días |
...
| alfa2 | _en vivo · 18 ciclos · 3408 pases observados_ | — | 0.35 `▓░░░░░` |
| jupiter | _en vivo · atención colectiva_ | — | 0.35 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 42.0% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 38.9% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.35 |
| beta1 | 99.8% | 65.5% | — | 0.30 |
| beta2 | 99.3% | 23.1% | — | 0.30 |
| delta | 99.5% | 27.0% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.35 |
| omega | 99.9% | 74.0% | — | 0.30 |
| padre | 99.2% | 44.5% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,141
...
| Asertividad viva | 42.0% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,141 | — | — aciertos |
| Pendientes de auditoría | 664 | — | — |
| Pesos de bots | alfa1 0.30, alfa2 0.35, beta1 0.30, beta2 0.30, delta 0.30, jupiter 0.35, omega 0.30, padre 0.30 | — | primera bitácora |
