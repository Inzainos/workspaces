...
**Generado:** 2026-08-21 12:59 UTC (06:59 UTC-6)
...
| Hora de la medición | 2026-08-21 12:59 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.2, muro 3/5 (breach) y firma máxima 89%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.2 | 10.2 | 10.7 | 27.5 | P48 |
| Muro de los 5 | 3 | 2.4 | 2.5 | 3 | P100 |
| Silent Trigger | activo | 44% ciclos | 57% ciclos | — | — |
| Asertividad viva | 43% | 53% | — | — | — |
...
|---|---|---|---|---|
| **89%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 58 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 66 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **83%** `▓▓▓▓░` | SISMO_M7 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 5 | ~12 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.81 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.85 `▓▓▓░░░` |
| beta2 | 467 | 21,720 | 0.31 `▓░░░░░` |
| delta | 380 | 15,727 | 0.31 `▓░░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.32 `▓░░░░░` |
| alfa2 | _en vivo · 461 ciclos · 86475 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 42.8% |
| **Últimos 7 días** (viva) | 53.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 99.9% | 39.3% | — | 0.81 |
| beta1 | 99.9% | 66.3% | — | 0.85 |
| beta2 | 99.4% | 23.3% | — | 0.31 |
| delta | 99.7% | 27.3% | — | 0.31 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 45.0% | 53.1% | 0.32 |
...
- ACIERTO — avisó y el evento ocurrió: 2,274
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,041
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 161
...
| Asertividad viva | 42.8% | — | — |
| Aciertos / Fallos (vivos) | 2,274 / 3,041 | — | — aciertos |
| Pendientes de auditoría | 161 | — | — |
| Pesos de bots | alfa1 0.81, beta1 0.85, beta2 0.31, delta 0.31, omega 1.00, padre 0.32 | — | primera bitácora |
