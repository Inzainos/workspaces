...
**Generado:** 2026-08-30 21:17 UTC (15:17 UTC-6)
...
| Hora de la medición | 2026-08-30 20:52 UTC | |
...
**Nivel del corte: 🟡 AMARILLO** — con Fantasma 9.9, muro 1/5 y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.9 | 8.6 | 10.1 | 27.5 | P49 |
| Muro de los 5 | 1 | 1.7 | 2.3 | 3 | P14 |
| Silent Trigger | inactivo | 67% ciclos | 75% ciclos | — | — |
| Asertividad viva | 42% | — | — | — | — |
...
| **87%** `▓▓▓▓░` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 24 | ~9 días |
...
| alfa2 | _en vivo · 19 ciclos · 3593 pases observados_ | — | 0.30 `▓░░░░░` |
...
| **Viva** (operación real, auditada) | 41.9% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 38.7% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.30 |
| beta1 | 99.8% | 65.3% | — | 0.30 |
| beta2 | 99.3% | 23.0% | — | 0.30 |
| delta | 99.5% | 26.9% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.30 |
| omega | 99.9% | 73.2% | — | 0.30 |
| padre | 99.2% | 44.4% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,165
...
| Asertividad viva | 41.9% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,165 | — | — aciertos |
