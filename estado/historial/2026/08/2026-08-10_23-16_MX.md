...
**Generado:** 2026-08-11 05:16 UTC (23:16 UTC-6)
...
| Hora de la medición | 2026-08-11 05:16 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.5, muro 3/5 (breach) y firma máxima 87%.
...
| Silent Trigger | activo | 71% ciclos | 76% ciclos | — | — |
| Asertividad viva | 43% | 32% | — | — | — |
...
|---|---|---|---|---|
| **87%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Tlaxcala Acuífero** (19.3, -98.2) · nodo 118 | 31 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **GeoBat San Andreas Creep** (36.0, -120.5) · nodo 107 | 14 | ~8 días |
| **80%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 50 | ~8 días |
...
| alfa2 | _en vivo · 341 ciclos · 63801 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,213
...
| Aciertos / Fallos (vivos) | 2,213 / 2,983 | — | — aciertos |
