...
**Generado:** 2026-08-20 06:56 UTC (00:56 UTC-6)
...
| Hora de la medición | 2026-08-20 06:56 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 11.5, muro 3/5 (breach) y firma máxima 86%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.5 | 9.8 | 10.6 | 27.5 | P70 |
| Muro de los 5 | 3 | 2.5 | 2.5 | 3 | P100 |
| Silent Trigger | activo | 47% ciclos | 56% ciclos | — | — |
...
|---|---|---|---|---|
| **86%** `▓▓▓▓░` | SISMO_M6 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 30 | ~9 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 177 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **Grecia Helénica** (37.0, 22.0) · nodo 35 | 394 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 6 | ~9 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 27 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.83 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.87 `▓▓▓░░░` |
| beta2 | 467 | 21,720 | 0.31 `▓░░░░░` |
| delta | 380 | 15,727 | 0.31 `▓░░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.30 `▓░░░░░` |
| alfa2 | _en vivo · 446 ciclos · 83684 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,270
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,029
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 57
...
| Aciertos / Fallos (vivos) | 2,270 / 3,029 | — | — aciertos |
| Pendientes de auditoría | 57 | — | — |
| Pesos de bots | alfa1 0.83, beta1 0.87, beta2 0.31, delta 0.31, omega 1.00, padre 0.30 | — | primera bitácora |
