...
**Generado:** 2026-08-17 18:49 UTC (12:49 UTC-6)
...
| Hora de la medición | 2026-08-17 18:49 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.4, muro 3/5 (breach) y firma máxima 94%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.4 | 9.1 | 9.8 | 27.5 | P6 |
| Muro de los 5 | 3 | 2.6 | 2.6 | 3 | P100 |
| Silent Trigger | activo | 61% ciclos | 69% ciclos | — | — |
| Asertividad viva | 43% | 34% | — | — | — |
...
|---|---|---|---|---|
| **94%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 65 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 6 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 103 | ~8 días |
| **86%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 10 | ~9 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.85 `▓▓▓░░░` |
| beta1 | 494 | 49,001 | 0.89 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.31 `▓░░░░░` |
| delta | 380 | 15,727 | 0.31 `▓░░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.31 `▓░░░░░` |
| alfa2 | _en vivo · 417 ciclos · 78165 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- ACIERTO — avisó y el evento ocurrió: 2,248
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,020
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 38
...
| Aciertos / Fallos (vivos) | 2,248 / 3,020 | — | — aciertos |
| Pendientes de auditoría | 38 | — | — |
| Pesos de bots | alfa1 0.85, beta1 0.89, beta2 0.31, delta 0.31, omega 1.00, padre 0.31 | — | primera bitácora |
