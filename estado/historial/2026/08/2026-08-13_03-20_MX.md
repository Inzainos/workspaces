...
**Generado:** 2026-08-13 09:20 UTC (03:20 UTC-6)
...
| Hora de la medición | 2026-08-13 09:19 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 9.2, muro 3/5 (breach) y firma máxima 92%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 9.2 | 9.8 | 9.6 | 27.5 | P55 |
| Muro de los 5 | 3 | 2.0 | 2.4 | 3 | P100 |
| Silent Trigger | activo | 59% ciclos | 74% ciclos | — | — |
| Asertividad viva | 43% | 68% | — | — | — |
...
|---|---|---|---|---|
| **92%** `▓▓▓▓▓` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 30 | ~8 días |
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 33 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 62 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Japón Nankai Fluidos** (33.5, 136.0) · nodo 108 | 16 | ~8 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.89 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 0.93 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.44 `▓▓░░░░` |
| delta | 380 | 15,727 | 0.44 `▓▓░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.40 `▓▓░░░░` |
| alfa2 | _en vivo · 365 ciclos · 68255 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Viva** (operación real, auditada) | 42.7% |
| **Últimos 7 días** (viva) | 67.5% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.89 |
| beta1 | 99.9% | 66.3% | — | 0.93 |
| beta2 | 99.5% | 23.3% | — | 0.44 |
| delta | 99.8% | 27.3% | — | 0.44 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 44.9% | 67.5% | 0.40 |
...
- ACIERTO — avisó y el evento ocurrió: 2,230
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,989
...
| Asertividad viva | 42.7% | — | — |
| Aciertos / Fallos (vivos) | 2,230 / 2,989 | — | — aciertos |
| Pendientes de auditoría | 35 | — | — |
| Pesos de bots | alfa1 0.89, beta1 0.93, beta2 0.44, delta 0.44, omega 1.00, padre 0.40 | — | primera bitácora |
