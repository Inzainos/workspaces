...
**Generado:** 2026-08-30 00:01 UTC (18:01 UTC-6)
...
| Hora de la medición | 2026-08-30 00:01 UTC | |
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.6 | 8.7 | 10.1 | 27.5 | P86 |
| Muro de los 5 | 1 | 1.8 | 2.3 | 3 | P12 |
| Silent Trigger | inactivo | 75% ciclos | 77% ciclos | — | — |
| Asertividad viva | 42% | — | — | — | — |
...
|---|---|---|---|---|
| **90%** `▓▓▓▓▓` | SISMO_M6 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 24 | ~9 días |
| **90%** `▓▓▓▓░` | SISMO_M5 | **Ghost Mariana** (15.0, 147.0) · nodo 81 | 288 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Perú Subducción** (-12.0, -77.0) · nodo 29 | 83 | ~8 días |
| **89%** `▓▓▓▓░` | SISMO_M5 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 279 | ~8 días |
| **88%** `▓▓▓▓░` | SISMO_M6 | **Ghost Oaxaca Interior** (16.8, -96.5) · nodo 71 | 38 | ~9 días |
...
| alfa2 | _en vivo · 15 ciclos · 2853 pases observados_ | — | 0.58 `▓▓░░░░` |
| jupiter | _en vivo · atención colectiva_ | — | 0.58 `▓▓░░░░` |
...
| **Viva** (operación real, auditada) | 42.3% |
| **Últimos 7 días** (viva) | — |
...
|---|---|---|---|---|
| alfa1 | 99.9% | 39.0% | — | 0.30 |
| alfa2 | 0.0% | 0.0% | — | 0.58 |
| beta1 | 99.8% | 65.8% | — | 0.30 |
| beta2 | 99.3% | 23.2% | — | 0.30 |
| delta | 99.5% | 27.1% | — | 0.30 |
| jupiter | 0.0% | 0.0% | — | 0.58 |
| omega | 99.9% | 74.9% | — | 0.30 |
| padre | 99.2% | 44.6% | — | 0.30 |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,109
...
| Asertividad viva | 42.3% | — | — |
| Aciertos / Fallos (vivos) | 2,279 / 3,109 | — | — aciertos |
| Pendientes de auditoría | 672 | — | — |
| Pesos de bots | alfa1 0.30, alfa2 0.58, beta1 0.30, beta2 0.30, delta 0.30, jupiter 0.58, omega 0.30, padre 0.30 | — | primera bitácora |
