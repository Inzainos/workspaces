...
**Generado:** 2026-08-17 01:42 UTC (19:42 UTC-6)
...
| Hora de la medición | 2026-08-17 01:42 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 6.5, muro 3/5 (breach) y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 6.5 | 9.6 | 9.8 | 27.5 | P7 |
| Muro de los 5 | 3 | 2.6 | 2.6 | 3 | P100 |
| Silent Trigger | activo | 63% ciclos | 73% ciclos | — | — |
| Asertividad viva | 43% | 42% | — | — | — |
...
|---|---|---|---|---|
| **90%** `▓▓▓▓░` | SISMO_M5 | **Japón Nankai** (33.0, 135.0) · nodo 21 | 9 | ~8 días |
| **85%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 30 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **Veracruz Costa** (19.2, -96.1) · nodo 47 | 9 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 62 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M6 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~9 días |
...
| alfa2 | _en vivo · 408 ciclos · 76428 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,013
...
| Aciertos / Fallos (vivos) | 2,248 / 3,013 | — | — aciertos |
