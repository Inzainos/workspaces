...
**Generado:** 2026-08-21 18:44 UTC (12:44 UTC-6)
...
| Hora de la medición | 2026-08-21 18:44 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.0, muro 3/5 (breach) y firma máxima 89%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.0 | 10.2 | 10.7 | 27.5 | P46 |
| Muro de los 5 | 3 | 2.5 | 2.5 | 3 | P100 |
| Silent Trigger | activo | 45% ciclos | 58% ciclos | — | — |
| Asertividad viva | 43% | 54% | — | — | — |
...
| **88%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 66 | ~8 días |
| **87%** `▓▓▓▓░` | SISMO_M6 | **Islandia Rift** (65.0, -18.0) · nodo 36 | 10 | ~9 días |
| **86%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 300 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M7 | **GeoBat Sumatra Hidrotermal** (1.0, 98.0) · nodo 109 | 5 | ~12 días |
...
| alfa2 | _en vivo · 464 ciclos · 86845 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 3,043
- FALSO POSITIVO — avisó y no pasó nada: 1
- PENDIENTE — ventana de 72h aún abierta: 183
...
| Aciertos / Fallos (vivos) | 2,274 / 3,043 | — | — aciertos |
| Pendientes de auditoría | 183 | — | — |
| Pesos de bots | alfa1 0.81, beta1 0.85, beta2 0.31, delta 0.31, omega 1.00, padre 0.30 | — | primera bitácora |
