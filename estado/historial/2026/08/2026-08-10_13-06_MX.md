...
**Generado:** 2026-08-10 19:06 UTC (13:06 UTC-6)
...
| Hora de la medición | 2026-08-10 19:06 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 11.3, muro 3/5 (breach) y firma máxima 90%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 11.3 | 9.5 | 9.5 | 27.5 | P76 |
| Muro de los 5 | 3 | 1.7 | 2.2 | 3 | P100 |
| Silent Trigger | activo | 64% ciclos | 75% ciclos | — | — |
...
| **87%** `▓▓▓▓░` | SISMO_M5 | **Ghost Scotia Arc** (-57.0, -30.0) · nodo 97 | 104 | ~8 días |
...
| alfa2 | _en vivo · 336 ciclos · 62887 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,980
...
| Aciertos / Fallos (vivos) | 2,210 / 2,980 | — | — aciertos |
