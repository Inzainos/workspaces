...
**Generado:** 2026-08-11 09:07 UTC (03:07 UTC-6)
...
| Hora de la medición | 2026-08-11 09:06 UTC | |
...
**Nivel del corte: 🟠 NARANJA** — con Fantasma 10.7, muro 3/5 (breach) y firma máxima 85%.
...
|---|---:|---:|---:|---:|---:|
| Fantasma | 10.7 | 9.5 | 9.5 | 27.5 | P70 |
| Muro de los 5 | 3 | 1.9 | 2.3 | 3 | P100 |
| Silent Trigger | activo | 71% ciclos | 81% ciclos | — | — |
| Asertividad viva | 43% | 37% | — | — | — |
...
|---|---|---|---|---|
| **85%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 8 | ~8 días |
| **84%** `▓▓▓▓░` | SISMO_M5 | **GeoBat Tlaxcala Acuífero** (19.3, -98.2) · nodo 118 | 31 | ~8 días |
| **82%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 50 | ~8 días |
| **81%** `▓▓▓▓░` | SISMO_M5 | **Baja California Sur** (24.1, -110.0) · nodo 14 | 103 | ~8 días |
| **80%** `▓▓▓▓░` | SISMO_M6 | **GeoBat Cascadia Fluidos** (45.5, -124.5) · nodo 106 | 11 | ~9 días |
...
|---|---|---|---|
| alfa1 | 114 | 49,001 | 0.91 `▓▓▓▓░░` |
| beta1 | 494 | 49,001 | 0.95 `▓▓▓▓░░` |
| beta2 | 467 | 21,720 | 0.52 `▓▓░░░░` |
| delta | 380 | 15,727 | 0.52 `▓▓░░░░` |
| omega | 360 | 179,235 | 1.00 `▓▓▓▓░░` |
| padre | 2,249 | 49,001 | 0.45 `▓▓░░░░` |
| alfa2 | _en vivo · 343 ciclos · 64169 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
| **Últimos 7 días** (viva) | 37.1% |

### Por bot

| Bot | Histórica | Viva | Viva 7d | Credibilidad |
|---|---|---|---|---|
| alfa1 | 100.0% | 39.3% | — | 0.91 |
| beta1 | 99.9% | 66.3% | — | 0.95 |
| beta2 | 99.5% | 23.3% | — | 0.52 |
| delta | 99.8% | 27.3% | — | 0.52 |
| omega | 99.9% | 76.7% | — | 1.00 |
| padre | 99.3% | 44.5% | 37.1% | 0.45 |
...
| Aciertos / Fallos (vivos) | 2,215 / 2,983 | — | — aciertos |
| Pendientes de auditoría | 34 | — | — |
| Pesos de bots | alfa1 0.91, beta1 0.95, beta2 0.52, delta 0.52, omega 1.00, padre 0.45 | — | primera bitácora |
...
*Ciclos totales: 140 · Sentinel Omega · Fractal Core Research*
