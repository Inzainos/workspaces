...
**Generado:** 2026-08-07 18:00 UTC (12:00 UTC-6)
...
| Hora de la medición | 2026-08-07 17:57 UTC | |
...
| **97%** `▓▓▓▓▓` | SISMO_M5 | **Chiapas Subducción** (14.8, -92.5) · nodo 3 | 33 | ~8 días |
| **94%** `▓▓▓▓▓` | SISMO_M4 | **Kamchatka** (53.0, 159.0) · nodo 20 | 91 | ~8 días |
...
| alfa2 | _en vivo · 318 ciclos · 56705 pases observados_ | — | 1.00 `▓▓▓▓░░` |
...
- FALLO — el evento ocurrió sin aviso (lo más castigado): 2,619
- PENDIENTE — ventana de 72h aún abierta: 877
...
| Asertividad viva | 9.2% | 9.3% | -0.1% |
| Aciertos / Fallos (vivos) | 266 / 2,619 | 266 / 2,595 | +0 aciertos |
| Pendientes de auditoría | 877 | 879 | -2 |
...
| **Total predicciones** | 870971 |

### 🤖 Desempeño por Bot

| Bot | Aciertos | Tasa | Confianza |
|-----|----------|------|-----------|
| padre | 178850/181469 | 99% `▓▓▓▓▓▓▓▓` | 0.98 |
...
*Ciclos totales: 3,770 · Sentinel Omega · Fractal Core Research*
